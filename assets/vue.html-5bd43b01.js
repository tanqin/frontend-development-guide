...
`)])])],-1),k=n("div",{class:"language-typescript","data-ext":"ts"},[n("pre",{class:"language-typescript"},[n("code",null,[n("span",{class:"token comment"},"// @/utils/index.ts"),a(`
`),n("span",{class:"token doc-comment comment"},[a(`/**
 * 求两数之和
...
│    └── <span class="token punctuation">..</span>.
└── <span class="token punctuation">..</span>.
</code></pre></div><div class="custom-container tip"><p class="custom-container-title">原因：</p><p>集中管理，方便查找。</p></div><hr><h2 id="枚举数据" tabindex="-1"><a class="header-anchor" href="#枚举数据" aria-hidden="true">#</a> 枚举数据</h2><ul><li>所有枚举定义文件统一放到 <code>@/enums</code> 目录下，且文件以 <code>模块名.enum.ts</code> 的范式命名。</li></ul>`,14),_=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[a(`my-project
├── src
│    └── enums                    // 枚举文件夹
│    │   └── userManage               // 用户管理
│    │       └── index.ts                 // 枚举文件
...
│    └── `),n("span",{class:"token punctuation"},".."),a(`.
└── `),n("span",{class:"token punctuation"},".."),a(`.
`)])])],-1),g=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[a(`my-project
├── src
│    └── enums                    // 枚举文件夹
...
│    └── `),n("span",{class:"token punctuation"},".."),a(`.
└── `),n("span",{class:"token punctuation"},".."),a(`.
`)])])],-1),v=n("div",{class:"custom-container tip"},[n("p",{class:"custom-container-title"},"原因："),n("p",null,"集中管理，方便查找。")],-1),x=n("hr",null,null,-1),y=n("h2",{id:"typescript-类型或接口定义",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#typescript-类型或接口定义","aria-hidden":"true"},"#"),a(" TypeScript 类型或接口定义")],-1),b=n("ul",null,[n("li",null,[a("类型或接口定义文件统一放在 "),n("code",null,"@/types"),a(" 目录下，且文件以 "),n("code",null,"模块名.type.ts"),a(" 的范式命名。")])],-1),f=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[a(`my-project
├── src
│    └── types                    // 类型文件夹
│    │   └── userManage               // 用户管理
│    │       └── index.ts                 // 类型文件
...
│    └── `),n("span",{class:"token punctuation"},".."),a(`.
└── `),n("span",{class:"token punctuation"},".."),a(`.
`)])])],-1),w=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[a(`my-project
├── src
│    └── types                    // 类型文件夹
...
│    └── `),n("span",{class:"token punctuation"},".."),a(`.
└── `),n("span",{class:"token punctuation"},".."),a(`.
`)])])],-1),V=o('<div class="custom-container tip"><p class="custom-container-title">原因：</p><p>类型文件单独存放，避免与页面逻辑文件混放造成干扰开发者的情况。</p></div><hr><h2 id="移除打印" tabindex="-1"><a class="header-anchor" href="#移除打印" aria-hidden="true">#</a> 移除打印</h2><ul><li>请在代码提交前删除页面中所有的 <code>console</code> 打印。</li></ul><div class="custom-container tip"><p class="custom-container-title">原因：</p><p>虽然项目打包后我们一般会去除所有打印信息，但是在开发阶段，console 打印在 devtools 打开的情况下会造成内存泄漏。而且过多的打印信息会有时会干扰到其他开发者调试代码。</p></div><hr><h2 id="移除冗余注释" tabindex="-1"><a class="header-anchor" href="#移除冗余注释" aria-hidden="true">#</a> 移除冗余注释</h2><ul><li>如果由于需求变更，原本的一段旧代码不适用时，请删除它，而不是注释它。你或许担心未来这段代码需要重新使用时通过 SVN 查找过于麻烦，我认为你大可不必吝啬这一点查找的时间，并且，大多数情况下你的这一段旧代码再也不会使用，它会一直躺在那。</li></ul><div class="custom-container tip"><p class="custom-container-title">原因：</p><p>冗余注释增加代码管理成本，导致后续维护者不确定这段旧代码是否重要。</p></div>',9);function M(j,S){const t=l("CodeGroupItem"),c=l("CodeGroup");return i(),u("div",null,[d,s(c,null,{default:e(()=>[s(t,{title:"【 Vue2 + JavaScript 】",active:""},{default:e(()=>[h]),_:1}),s(t,{title:"【 Vue3 + TypeScript 】"},{default:e(()=>[k]),_:1})]),_:1}),m,s(c,null,{default:e(()=>[s(t,{title:"【 Vue2 + JavaScript 】",active:""},{default:e(()=>[_]),_:1}),s(t,{title:"【 Vue3 + TypeScript 】"},{default:e(()=>[g]),_:1})]),_:1}),v,x,y,b,s(c,null,{default:e(()=>[s(t,{title:"【 Vue2 + JavaScript 】",active:""},{default:e(()=>[f]),_:1}),s(t,{title:"【 Vue3 + TypeScript 】"},{default:e(()=>[w]),_:1})]),_:1}),V])}const T=p(r,[["render",M],["__file","vue.html.vue"]]);export{T as default};
