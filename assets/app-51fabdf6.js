...
#endif`,$m="vec3 transformed = vec3( position );",Ym=`vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
void main() {
	...
	`}function Tv(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Yr||l===$s,u=l===Oi||l===Fi;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let h=e.get(o);return t===null&&(t=new Qa(i)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),e.set(o,h),h.texture}else{if(e.has(o))return e.get(o).texture;{const h=o.image;if(c&&h&&h.height>0||u&&h&&r(h)){t===null&&(t=new Qa(i));const d=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,d),o.addEventListener("dispose",s),d.texture}else return null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Av(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function wv(i,e,t,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let m=0,f=v.length;m<f;m++)e.remove(v[m])}d.removeEventListener("dispose",a),delete r[d.id];const p=s.get(d);p&&(e.remove(p),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const p=h.morphAttributes;for(const g in p){const v=p[g];for(let m=0,f=v.length;m<f;m++)e.update(v[m],i.ARRAY_BUFFER)}}function c(h){const d=[],p=h.index,g=h.attributes.position;let v=0;if(p!==null){const b=p.array;v=p.version;for(let _=0,T=b.length;_<T;_+=3){const A=b[_+0],P=b[_+1],L=b[_+2];d.push(A,P,P,L,L,A)}}else{const b=g.array;v=g.version;for(let _=0,T=b.length/3-1;_<T;_+=3){const A=_+0,P=_+1,L=_+2;d.push(A,P,P,L,L,A)}}const m=new(mc(d)?Ec:yc)(d,1);m.version=v;const f=s.get(h);f&&e.remove(f),s.set(h,m)}function u(h){const d=s.get(h);if(d){const p=h.index;p!==null&&d.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Rv(i,e,t,n){const r=n.isWebGL2;let s;function a(d){s=d}let o,l;function c(d){o=d.type,l=d.bytesPerElement}function u(d,p){i.drawElements(s,p,o,d*l),t.update(p,s,1)}function h(d,p,g){if(g===0)return;let v,m;if(r)v=i,m="drawElementsInstanced";else if(v=e.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",v===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}v[m](s,p,o,d*l,g),t.update(p,s,g)}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=h}function Cv(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Lv(i,e){return i[0]-e[0]}function Pv(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Dv(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,a=new bt,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,h){const d=c.morphTargetInfluences;if(e.isWebGL2===!0){const p=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,g=p!==void 0?p.length:0;let v=s.get(u);if(v===void 0||v.count!==g){let N=function(){$.dispose(),s.delete(u),u.removeEventListener("dispose",N)};v!==void 0&&v.texture.dispose();const b=u.morphAttributes.position!==void 0,_=u.morphAttributes.normal!==void 0,T=u.morphAttributes.color!==void 0,A=u.morphAttributes.position||[],P=u.morphAttributes.normal||[],L=u.morphAttributes.color||[];let y=0;b===!0&&(y=1),_===!0&&(y=2),T===!0&&(y=3);let x=u.attributes.position.count*y,E=1;x>e.maxTextureSize&&(E=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);const z=new Float32Array(x*E*4*g),$=new vc(z,x,E,g);$.type=In,$.needsUpdate=!0;const I=y*4;for(let F=0;F<g;F++){const W=A[F],G=P[F],q=L[F],Z=x*E*4*F;for(let Q=0;Q<W.count;Q++){const de=Q*I;b===!0&&(a.fromBufferAttribute(W,Q),z[Z+de+0]=a.x,z[Z+de+1]=a.y,z[Z+de+2]=a.z,z[Z+de+3]=0),_===!0&&(a.fromBufferAttribute(G,Q),z[Z+de+4]=a.x,z[Z+de+5]=a.y,z[Z+de+6]=a.z,z[Z+de+7]=0),T===!0&&(a.fromBufferAttribute(q,Q),z[Z+de+8]=a.x,z[Z+de+9]=a.y,z[Z+de+10]=a.z,z[Z+de+11]=q.itemSize===4?a.w:1)}}v={count:g,texture:$,size:new ce(x,E)},s.set(u,v),u.addEventListener("dispose",N)}let m=0;for(let b=0;b<d.length;b++)m+=d[b];const f=u.morphTargetsRelative?1:1-m;h.getUniforms().setValue(i,"morphTargetBaseInfluence",f),h.getUniforms().setValue(i,"morphTargetInfluences",d),h.getUniforms().setValue(i,"morphTargetsTexture",v.texture,t),h.getUniforms().setValue(i,"morphTargetsTextureSize",v.size)}else{const p=d===void 0?0:d.length;let g=n[u.id];if(g===void 0||g.length!==p){g=[];for(let _=0;_<p;_++)g[_]=[_,0];n[u.id]=g}for(let _=0;_<p;_++){const T=g[_];T[0]=_,T[1]=d[_]}g.sort(Pv);for(let _=0;_<8;_++)_<p&&g[_][1]?(o[_][0]=g[_][0],o[_][1]=g[_][1]):(o[_][0]=Number.MAX_SAFE_INTEGER,o[_][1]=0);o.sort(Lv);const v=u.morphAttributes.position,m=u.morphAttributes.normal;let f=0;for(let _=0;_<8;_++){const T=o[_],A=T[0],P=T[1];A!==Number.MAX_SAFE_INTEGER&&P?(v&&u.getAttribute("morphTarget"+_)!==v[A]&&u.setAttribute("morphTarget"+_,v[A]),m&&u.getAttribute("morphNormal"+_)!==m[A]&&u.setAttribute("morphNormal"+_,m[A]),r[_]=P,f+=P):(v&&u.hasAttribute("morphTarget"+_)===!0&&u.deleteAttribute("morphTarget"+_),m&&u.hasAttribute("morphNormal"+_)===!0&&u.deleteAttribute("morphNormal"+_),r[_]=0)}const b=u.morphTargetsRelative?1:1-f;h.getUniforms().setValue(i,"morphTargetBaseInfluence",b),h.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:l}}function Iv(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);return r.get(h)!==c&&(e.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER)),h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:a}}const Cc=new Ut,Lc=new vc,Pc=new Mm,Dc=new Ac,il=[],rl=[],sl=new Float32Array(16),ol=new Float32Array(9),al=new Float32Array(4);function Hi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=il[r];if(s===void 0&&(s=new Float32Array(r),il[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function _t(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function vt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ts(i,e){let t=rl[e];t===void 0&&(t=new Int32Array(e),rl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Uv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Nv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2fv(this.addr,e),vt(t,e)}}function Ov(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;i.uniform3fv(this.addr,e),vt(t,e)}}function Fv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4fv(this.addr,e),vt(t,e)}}function Bv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;al.set(n),i.uniformMatrix2fv(this.addr,!1,al),vt(t,n)}}function zv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;ol.set(n),i.uniformMatrix3fv(this.addr,!1,ol),vt(t,n)}}function kv(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;sl.set(n),i.uniformMatrix4fv(this.addr,!1,sl),vt(t,n)}}function Hv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Gv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2iv(this.addr,e),vt(t,e)}}function Vv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3iv(this.addr,e),vt(t,e)}}function Wv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4iv(this.addr,e),vt(t,e)}}function Xv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function qv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;i.uniform2uiv(this.addr,e),vt(t,e)}}function $v(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;i.uniform3uiv(this.addr,e),vt(t,e)}}function Yv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;i.uniform4uiv(this.addr,e),vt(t,e)}}function jv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||Cc,r)}function Kv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Pc,r)}function Zv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Dc,r)}function Jv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Lc,r)}function Qv(i){switch(i){case 5126:return Uv;case 35664:return Nv;case 35665:return Ov;case 35666:return Fv;case 35674:return Bv;case 35675:return zv;case 35676:return kv;case 5124:case 35670:return Hv;case 35667:case 35671:return Gv;case 35668:case 35672:return Vv;case 35669:case 35673:return Wv;case 5125:return Xv;case 36294:return qv;case 36295:return $v;case 36296:return Yv;case 35678:case 36198:case 36298:case 36306:case 35682:return jv;case 35679:case 36299:case 36307:return Kv;case 35680:case 36300:case 36308:case 36293:return Zv;case 36289:case 36303:case 36311:case 36292:return Jv}}function e0(i,e){i.uniform1fv(this.addr,e)}function t0(i,e){const t=Hi(e,this.size,2);i.uniform2fv(this.addr,t)}function n0(i,e){const t=Hi(e,this.size,3);i.uniform3fv(this.addr,t)}function i0(i,e){const t=Hi(e,this.size,4);i.uniform4fv(this.addr,t)}function r0(i,e){const t=Hi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function s0(i,e){const t=Hi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function o0(i,e){const t=Hi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function a0(i,e){i.uniform1iv(this.addr,e)}function l0(i,e){i.uniform2iv(this.addr,e)}function c0(i,e){i.uniform3iv(this.addr,e)}function u0(i,e){i.uniform4iv(this.addr,e)}function h0(i,e){i.uniform1uiv(this.addr,e)}function d0(i,e){i.uniform2uiv(this.addr,e)}function f0(i,e){i.uniform3uiv(this.addr,e)}function p0(i,e){i.uniform4uiv(this.addr,e)}function m0(i,e,t){const n=this.cache,r=e.length,s=ts(t,r);_t(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||Cc,s[a])}function g0(i,e,t){const n=this.cache,r=e.length,s=ts(t,r);_t(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Pc,s[a])}function _0(i,e,t){const n=this.cache,r=e.length,s=ts(t,r);_t(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Dc,s[a])}function v0(i,e,t){const n=this.cache,r=e.length,s=ts(t,r);_t(n,s)||(i.uniform1iv(this.addr,s),vt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Lc,s[a])}function x0(i){switch(i){case 5126:return e0;case 35664:return t0;case 35665:return n0;case 35666:return i0;case 35674:return r0;case 35675:return s0;case 35676:return o0;case 5124:case 35670:return a0;case 35667:case 35671:return l0;case 35668:case 35672:return c0;case 35669:case 35673:return u0;case 5125:return h0;case 36294:return d0;case 36295:return f0;case 36296:return p0;case 35678:case 36198:case 36298:case 36306:case 35682:return m0;case 35679:case 36299:case 36307:return g0;case 35680:case 36300:case 36308:case 36293:return _0;case 36289:case 36303:case 36311:case 36292:return v0}}class M0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=Qv(t.type)}}class S0{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=x0(t.type)}}class y0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const Bs=/(\w+)(\])?(\[|\.)?/g;function ll(i,e){i.seq.push(e),i.map[e.id]=e}function E0(i,e,t){const n=i.name,r=n.length;for(Bs.lastIndex=0;;){const s=Bs.exec(n),a=Bs.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){ll(t,c===void 0?new M0(o,i,e):new S0(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new y0(o),ll(t,h)),t=h}}}class Gr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);E0(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function cl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let b0=0;function T0(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function A0(i){switch(i){case on:return["Linear","( value )"];case ke:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function ul(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+T0(i.getShaderSource(e),a)}else return r}function w0(i,e){const t=A0(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function R0(i,e){let t;switch(e){case Bp:t="Linear";break;case zp:t="Reinhard";break;case kp:t="OptimizedCineon";break;case Hp:t="ACESFilmic";break;case Gp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function C0(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Yi).join(`
`)}function L0(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function P0(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Yi(i){return i!==""}function hl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function dl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const D0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Qs(i){return i.replace(D0,I0)}function I0(i,e){const t=He[e];if(t===void 0)throw new Error("Can not resolve #include <"+e+">");return Qs(t)}const U0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fl(i){return i.replace(U0,N0)}function N0(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function pl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function O0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===tc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===gp?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===_n&&(e="SHADOWMAP_TYPE_VSM"),e}function F0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Oi:case Fi:e="ENVMAP_TYPE_CUBE";break;case Qr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function B0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Fi:e="ENVMAP_MODE_REFRACTION";break}return e}function z0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case rc:e="ENVMAP_BLENDING_MULTIPLY";break;case Op:e="ENVMAP_BLENDING_MIX";break;case Fp:e="ENVMAP_BLENDING_ADD";break}return e}function k0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function H0(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=O0(t),c=F0(t),u=B0(t),h=z0(t),d=k0(t),p=t.isWebGL2?"":C0(t),g=L0(s),v=r.createProgram();let m,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+x+`
`+N+`
`+F)}else x!==""?console.warn("THREE.WebGLProgram: Program Info Log:",x):(E===""||z==="")&&(I=!1);I&&(this.diagnostics={runnable:$,programLog:x,vertexShader:{log:E,prefix:m},fragmentShader:{log:z,prefix:f}})}r.deleteShader(A),r.deleteShader(P);let L;this.getUniforms=function(){return L===void 0&&(L=new Gr(r,v)),L};let y;return this.getAttributes=function(){return y===void 0&&(y=P0(r,v)),y},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=b0++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=A,this.fragmentShader=P,this}let G0=0;class V0{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new W0(e),t.set(e,n)),n}}class W0{constructor(e){this.id=G0++,this.code=e,this.usedTimes=0}}function X0(i,e,t,n,r,s,a){const o=new xc,l=new V0,c=[],u=r.isWebGL2,h=r.logarithmicDepthBuffer,d=r.vertexTextures;let p=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(x){return x===0?"uv":`uv${x}`}function m(x,E,z,$,I){const N=$.fog,F=I.geometry,W=x.isMeshStandardMaterial?$.environment:null,G=(x.isMeshStandardMaterial?t:e).get(x.envMap||W),q=G&&G.mapping===Qr?G.image.height:null,Z=g[x.type];x.precision!==null&&(p=r.getMaxPrecision(x.precision),p!==x.precision&&console.warn("THREE.WebGLProgram.getParameters:",x.precision,"not supported, using",p,"instead."));const Q=F.morphAttributes.position||F.morphAttributes.normal||F.morphAttributes.color,de=Q!==void 0?Q.length:0;let k=0;F.morphAttributes.position!==void 0&&(k=1),F.morphAttributes.normal!==void 0&&(k=2),F.morphAttributes.color!==void 0&&(k=3);let te,ne,fe,ve;if(Z){const dt=nn[Z];te=dt.vertexShader,ne=dt.fragmentShader}else te=x.vertexShader,ne=x.fragmentShader,l.update(x),fe=l.getVertexShaderID(x),ve=l.getFragmentShaderID(x);const Me=i.getRenderTarget(),Ie=I.isInstancedMesh===!0,Le=!!x.map,Ye=!!x.matcap,Pe=!!G,C=!!x.aoMap,ae=!!x.lightMap,K=!!x.bumpMap,se=!!x.normalMap,J=!!x.displacementMap,Ae=!!x.emissiveMap,ge=!!x.metalnessMap,xe=!!x.roughnessMap,Ue=x.anisotropy>0,We=x.clearcoat>0,st=x.iridescence>0,w=x.sheen>0,M=x.transmission>0,X=Ue&&!!x.anisotropyMap,oe=We&&!!x.clearcoatMap,re=We&&!!x.clearcoatNormalMap,R=We&&!!x.clearcoatRoughnessMap,ee=st&&!!x.iridescenceMap,ie=st&&!!x.iridescenceThicknessMap,H=w&&!!x.sheenColorMap,Ee=w&&!!x.sheenRoughnessMap,Re=!!x.specularMap,we=!!x.specularColorMap,be=!!x.specularIntensityMap,Se=M&&!!x.transmissionMap,Ne=M&&!!x.thicknessMap,qe=!!x.gradientMap,D=!!x.alphaMap,pe=x.alphaTest>0,V=!!x.extensions,ue=!!F.attributes.uv1,_e=!!F.attributes.uv2,Ze=!!F.attributes.uv3;return{isWebGL2:u,shaderID:Z,shaderType:x.type,shaderName:x.name,vertexShader:te,fragmentShader:ne,defines:x.defines,customVertexShaderID:fe,customFragmentShaderID:ve,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:p,instancing:Ie,instancingColor:Ie&&I.instanceColor!==null,supportsVertexTextures:d,outputColorSpace:Me===null?i.outputColorSpace:Me.isXRRenderTarget===!0?Me.texture.colorSpace:on,map:Le,matcap:Ye,envMap:Pe,envMapMode:Pe&&G.mapping,envMapCubeUVHeight:q,aoMap:C,lightMap:ae,bumpMap:K,normalMap:se,displacementMap:d&&J,emissiveMap:Ae,normalMapObjectSpace:se&&x.normalMapType===tm,normalMapTangentSpace:se&&x.normalMapType===fc,metalnessMap:ge,roughnessMap:xe,anisotropy:Ue,anisotropyMap:X,clearcoat:We,clearcoatMap:oe,clearcoatNormalMap:re,clearcoatRoughnessMap:R,iridescence:st,iridescenceMap:ee,iridescenceThicknessMap:ie,sheen:w,sheenColorMap:H,sheenRoughnessMap:Ee,specularMap:Re,specularColorMap:we,specularIntensityMap:be,transmission:M,transmissionMap:Se,thicknessMap:Ne,gradientMap:qe,opaque:x.transparent===!1&&x.blending===Di,alphaMap:D,alphaTest:pe,combine:x.combine,mapUv:Le&&v(x.map.channel),aoMapUv:C&&v(x.aoMap.channel),lightMapUv:ae&&v(x.lightMap.channel),bumpMapUv:K&&v(x.bumpMap.channel),normalMapUv:se&&v(x.normalMap.channel),displacementMapUv:J&&v(x.displacementMap.channel),emissiveMapUv:Ae&&v(x.emissiveMap.channel),metalnessMapUv:ge&&v(x.metalnessMap.channel),roughnessMapUv:xe&&v(x.roughnessMap.channel),anisotropyMapUv:X&&v(x.anisotropyMap.channel),clearcoatMapUv:oe&&v(x.clearcoatMap.channel),clearcoatNormalMapUv:re&&v(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:R&&v(x.clearcoatRoughnessMap.channel),iridescenceMapUv:ee&&v(x.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&v(x.iridescenceThicknessMap.channel),sheenColorMapUv:H&&v(x.sheenColorMap.channel),sheenRoughnessMapUv:Ee&&v(x.sheenRoughnessMap.channel),specularMapUv:Re&&v(x.specularMap.channel),specularColorMapUv:we&&v(x.specularColorMap.channel),specularIntensityMapUv:be&&v(x.specularIntensityMap.channel),transmissionMapUv:Se&&v(x.transmissionMap.channel),thicknessMapUv:Ne&&v(x.thicknessMap.channel),alphaMapUv:D&&v(x.alphaMap.channel),vertexTangents:!!F.attributes.tangent&&(se||Ue),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!F.attributes.color&&F.attributes.color.itemSize===4,vertexUv1s:ue,vertexUv2s:_e,vertexUv3s:Ze,pointsUvs:I.isPoints===!0&&!!F.attributes.uv&&(Le||D),fog:!!N,useFog:x.fog===!0,fogExp2:N&&N.isFogExp2,flatShading:x.flatShading===!0,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:I.isSkinnedMesh===!0,morphTargets:F.morphAttributes.position!==void 0,morphNormals:F.morphAttributes.normal!==void 0,morphColors:F.morphAttributes.color!==void 0,morphTargetsCount:de,morphTextureStride:k,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&z.length>0,shadowMapType:i.shadowMap.type,toneMapping:x.toneMapped?i.toneMapping:yn,useLegacyLights:i.useLegacyLights,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===rn,flipSided:x.side===It,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionDerivatives:V&&x.extensions.derivatives===!0,extensionFragDepth:V&&x.extensions.fragDepth===!0,extensionDrawBuffers:V&&x.extensions.drawBuffers===!0,extensionShaderTextureLOD:V&&x.extensions.shaderTextureLOD===!0,rendererExtensionFragDepth:u||n.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||n.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||n.has("EXT_shader_texture_lod"),customProgramCacheKey:x.customProgramCacheKey()}}function f(x){const E=[];if(x.shaderID?E.push(x.shaderID):(E.push(x.customVertexShaderID),E.push(x.customFragmentShaderID)),x.defines!==void 0)for(const z in x.defines)E.push(z),E.push(x.defines[z]);return x.isRawShaderMaterial===!1&&(b(E,x),_(E,x),E.push(i.outputColorSpace)),E.push(x.customProgramCacheKey),E.join()}function b(x,E){x.push(E.precision),x.push(E.outputColorSpace),x.push(E.envMapMode),x.push(E.envMapCubeUVHeight),x.push(E.mapUv),x.push(E.alphaMapUv),x.push(E.lightMapUv),x.push(E.aoMapUv),x.push(E.bumpMapUv),x.push(E.normalMapUv),x.push(E.displacementMapUv),x.push(E.emissiveMapUv),x.push(E.metalnessMapUv),x.push(E.roughnessMapUv),x.push(E.anisotropyMapUv),x.push(E.clearcoatMapUv),x.push(E.clearcoatNormalMapUv),x.push(E.clearcoatRoughnessMapUv),x.push(E.iridescenceMapUv),x.push(E.iridescenceThicknessMapUv),x.push(E.sheenColorMapUv),x.push(E.sheenRoughnessMapUv),x.push(E.specularMapUv),x.push(E.specularColorMapUv),x.push(E.specularIntensityMapUv),x.push(E.transmissionMapUv),x.push(E.thicknessMapUv),x.push(E.combine),x.push(E.fogExp2),x.push(E.sizeAttenuation),x.push(E.morphTargetsCount),x.push(E.morphAttributeCount),x.push(E.numDirLights),x.push(E.numPointLights),x.push(E.numSpotLights),x.push(E.numSpotLightMaps),x.push(E.numHemiLights),x.push(E.numRectAreaLights),x.push(E.numDirLightShadows),x.push(E.numPointLightShadows),x.push(E.numSpotLightShadows),x.push(E.numSpotLightShadowsWithMaps),x.push(E.shadowMapType),x.push(E.toneMapping),x.push(E.numClippingPlanes),x.push(E.numClipIntersection),x.push(E.depthPacking)}function _(x,E){o.disableAll(),E.isWebGL2&&o.enable(0),E.supportsVertexTextures&&o.enable(1),E.instancing&&o.enable(2),E.instancingColor&&o.enable(3),E.matcap&&o.enable(4),E.envMap&&o.enable(5),E.normalMapObjectSpace&&o.enable(6),E.normalMapTangentSpace&&o.enable(7),E.clearcoat&&o.enable(8),E.iridescence&&o.enable(9),E.alphaTest&&o.enable(10),E.vertexColors&&o.enable(11),E.vertexAlphas&&o.enable(12),E.vertexUv1s&&o.enable(13),E.vertexUv2s&&o.enable(14),E.vertexUv3s&&o.enable(15),E.vertexTangents&&o.enable(16),E.anisotropy&&o.enable(17),x.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.skinning&&o.enable(4),E.morphTargets&&o.enable(5),E.morphNormals&&o.enable(6),E.morphColors&&o.enable(7),E.premultipliedAlpha&&o.enable(8),E.shadowMapEnabled&&o.enable(9),E.useLegacyLights&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),x.push(o.mask)}function T(x){const E=g[x.type];let z;if(E){const $=nn[E];z=Im.clone($.uniforms)}else z=x.uniforms;return z}function A(x,E){let z;for(let $=0,I=c.length;$<I;$++){const N=c[$];if(N.cacheKey===E){z=N,++z.usedTimes;break}}return z===void 0&&(z=new H0(i,E,x,s),c.push(z)),z}function P(x){if(--x.usedTimes===0){const E=c.indexOf(x);c[E]=c[c.length-1],c.pop(),x.destroy()}}function L(x){l.remove(x)}function y(){l.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:T,acquireProgram:A,releaseProgram:P,releaseShaderCache:L,programs:c,dispose:y}}function q0(){let i=new WeakMap;function e(s){let a=i.get(s);return a===void 0&&(a={},i.set(s,a)),a}function t(s){i.delete(s)}function n(s,a,o){i.get(s)[a]=o}function r(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:r}}function $0(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function ml(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function gl(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(h,d,p,g,v,m){let f=i[e];return f===void 0?(f={id:h.id,object:h,geometry:d,material:p,groupOrder:g,renderOrder:h.renderOrder,z:v,group:m},i[e]=f):(f.id=h.id,f.object=h,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=h.renderOrder,f.z=v,f.group=m),e++,f}function o(h,d,p,g,v,m){const f=a(h,d,p,g,v,m);p.transmission>0?n.push(f):p.transparent===!0?r.push(f):t.push(f)}function l(h,d,p,g,v,m){const f=a(h,d,p,g,v,m);p.transmission>0?n.unshift(f):p.transparent===!0?r.unshift(f):t.unshift(f)}function c(h,d){t.length>1&&t.sort(h||$0),n.length>1&&n.sort(d||ml),r.length>1&&r.sort(d||ml)}function u(){for(let h=e,d=i.length;h<d;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function Y0(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new gl,i.set(n,[a])):r>=s.length?(a=new gl,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function j0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new U,color:new et};break;case"SpotLight":t={position:new U,direction:new U,color:new et,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new U,color:new et,distance:0,decay:0};break;case"HemisphereLight":t={direction:new U,skyColor:new et,groundColor:new et};break;case"RectAreaLight":t={color:new et,position:new U,halfWidth:new U,halfHeight:new U};break}return i[e.id]=t,t}}}function K0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ce};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ce};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ce,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Z0=0;function J0(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Q0(i,e){const t=new j0,n=K0(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let u=0;u<9;u++)r.probe.push(new U);const s=new U,a=new Et,o=new Et;function l(u,h){let d=0,p=0,g=0;for(let z=0;z<9;z++)r.probe[z].set(0,0,0);let v=0,m=0,f=0,b=0,_=0,T=0,A=0,P=0,L=0,y=0;u.sort(J0);const x=h===!0?Math.PI:1;for(let z=0,$=u.length;z<$;z++){const I=u[z],N=I.color,F=I.intensity,W=I.distance,G=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)d+=N.r*F*x,p+=N.g*F*x,g+=N.b*F*x;else if(I.isLightProbe)for(let q=0;q<9;q++)r.probe[q].addScaledVector(I.sh.coefficients[q],F);else if(I.isDirectionalLight){const q=t.get(I);if(q.color.copy(I.color).multiplyScalar(I.intensity*x),I.castShadow){const Z=I.shadow,Q=n.get(I);Q.shadowBias=Z.bias,Q.shadowNormalBias=Z.normalBias,Q.shadowRadius=Z.radius,Q.shadowMapSize=Z.mapSize,r.directionalShadow[v]=Q,r.directionalShadowMap[v]=G,r.directionalShadowMatrix[v]=I.shadow.matrix,T++}r.directional[v]=q,v++}else if(I.isSpotLight){const q=t.get(I);q.position.setFromMatrixPosition(I.matrixWorld),q.color.copy(N).multiplyScalar(F*x),q.distance=W,q.coneCos=Math.cos(I.angle),q.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),q.decay=I.decay,r.spot[f]=q;const Z=I.shadow;if(I.map&&(r.spotLightMap[L]=I.map,L++,Z.updateMatrices(I),I.castShadow&&y++),r.spotLightMatrix[f]=Z.matrix,I.castShadow){const Q=n.get(I);Q.shadowBias=Z.bias,Q.shadowNormalBias=Z.normalBias,Q.shadowRadius=Z.radius,Q.shadowMapSize=Z.mapSize,r.spotShadow[f]=Q,r.spotShadowMap[f]=G,P++}f++}else if(I.isRectAreaLight){const q=t.get(I);q.color.copy(N).multiplyScalar(F),q.halfWidth.set(I.width*.5,0,0),q.halfHeight.set(0,I.height*.5,0),r.rectArea[b]=q,b++}else if(I.isPointLight){const q=t.get(I);if(q.color.copy(I.color).multiplyScalar(I.intensity*x),q.distance=I.distance,q.decay=I.decay,I.castShadow){const Z=I.shadow,Q=n.get(I);Q.shadowBias=Z.bias,Q.shadowNormalBias=Z.normalBias,Q.shadowRadius=Z.radius,Q.shadowMapSize=Z.mapSize,Q.shadowCameraNear=Z.camera.near,Q.shadowCameraFar=Z.camera.far,r.pointShadow[m]=Q,r.pointShadowMap[m]=G,r.pointShadowMatrix[m]=I.shadow.matrix,A++}r.point[m]=q,m++}else if(I.isHemisphereLight){const q=t.get(I);q.skyColor.copy(I.color).multiplyScalar(F*x),q.groundColor.copy(I.groundColor).multiplyScalar(F*x),r.hemi[_]=q,_++}}b>0&&(e.isWebGL2||i.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=he.LTC_FLOAT_1,r.rectAreaLTC2=he.LTC_FLOAT_2):i.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=he.LTC_HALF_1,r.rectAreaLTC2=he.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=d,r.ambient[1]=p,r.ambient[2]=g;const E=r.hash;(E.directionalLength!==v||E.pointLength!==m||E.spotLength!==f||E.rectAreaLength!==b||E.hemiLength!==_||E.numDirectionalShadows!==T||E.numPointShadows!==A||E.numSpotShadows!==P||E.numSpotMaps!==L)&&(r.directional.length=v,r.spot.length=f,r.rectArea.length=b,r.point.length=m,r.hemi.length=_,r.directionalShadow.length=T,r.directionalShadowMap.length=T,r.pointShadow.length=A,r.pointShadowMap.length=A,r.spotShadow.length=P,r.spotShadowMap.length=P,r.directionalShadowMatrix.length=T,r.pointShadowMatrix.length=A,r.spotLightMatrix.length=P+L-y,r.spotLightMap.length=L,r.numSpotLightShadowsWithMaps=y,E.directionalLength=v,E.pointLength=m,E.spotLength=f,E.rectAreaLength=b,E.hemiLength=_,E.numDirectionalShadows=T,E.numPointShadows=A,E.numSpotShadows=P,E.numSpotMaps=L,r.version=Z0++)}function c(u,h){let d=0,p=0,g=0,v=0,m=0;const f=h.matrixWorldInverse;for(let b=0,_=u.length;b<_;b++){const T=u[b];if(T.isDirectionalLight){const A=r.directional[d];A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(f),d++}else if(T.isSpotLight){const A=r.spot[g];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(f),A.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(f),g++}else if(T.isRectAreaLight){const A=r.rectArea[v];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(f),o.identity(),a.copy(T.matrixWorld),a.premultiply(f),o.extractRotation(a),A.halfWidth.set(T.width*.5,0,0),A.halfHeight.set(0,T.height*.5,0),A.halfWidth.applyMatrix4(o),A.halfHeight.applyMatrix4(o),v++}else if(T.isPointLight){const A=r.point[p];A.position.setFromMatrixPosition(T.matrixWorld),A.position.applyMatrix4(f),p++}else if(T.isHemisphereLight){const A=r.hemi[m];A.direction.setFromMatrixPosition(T.matrixWorld),A.direction.transformDirection(f),m++}}}return{setup:l,setupView:c,state:r}}function _l(i,e){const t=new Q0(i,e),n=[],r=[];function s(){n.length=0,r.length=0}function a(h){n.push(h)}function o(h){r.push(h)}function l(h){t.setup(n,h)}function c(h){t.setupView(n,h)}return{init:s,state:{lightsArray:n,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:a,pushShadow:o}}function ex(i,e){let t=new WeakMap;function n(s,a=0){const o=t.get(s);let l;return o===void 0?(l=new _l(i,e),t.set(s,[l])):a>=o.length?(l=new _l(i,e),o.push(l)):l=o[a],l}function r(){t=new WeakMap}return{get:n,dispose:r}}class tx extends cr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Qp,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class nx extends cr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const ix=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function sx(i,e,t){let n=new wc;const r=new ce,s=new ce,a=new bt,o=new tx({depthPacking:em}),l=new nx,c={},u=t.maxTextureSize,h={[Fn]:It,[It]:Fn,[rn]:rn},d=new ii({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ce},radius:{value:4}},vertexShader:ix,fragmentShader:rx}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new Bn;g.setAttribute("position",new sn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new xn(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=tc;let f=this.type;this.render=function(A,P,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const y=i.getRenderTarget(),x=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),z=i.state;z.setBlending(Un),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const $=f!==_n&&this.type===_n,I=f===_n&&this.type!==_n;for(let N=0,F=A.length;N<F;N++){const W=A[N],G=W.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",W,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const q=G.getFrameExtents();if(r.multiply(q),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/q.x),r.x=s.x*q.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/q.y),r.y=s.y*q.y,G.mapSize.y=s.y)),G.map===null||$===!0||I===!0){const Q=this.type!==_n?{minFilter:Pt,magFilter:Pt}:{};G.map!==null&&G.map.dispose(),G.map=new ti(r.x,r.y,Q),G.map.texture.name=W.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const Z=G.getViewportCount();for(let Q=0;Q<Z;Q++){const de=G.getViewport(Q);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),z.viewport(a),G.updateMatrices(W,Q),n=G.getFrustum(),T(P,L,G.camera,W,this.type)}G.isPointLightShadow!==!0&&this.type===_n&&b(G,L),G.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(y,x,E)};function b(A,P){const L=e.update(v);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new ti(r.x,r.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,i.setRenderTarget(A.mapPass),i.clear(),i.renderBufferDirect(P,null,L,d,v,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,i.setRenderTarget(A.map),i.clear(),i.renderBufferDirect(P,null,L,p,v,null)}function _(A,P,L,y){let x=null;const E=L.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(E!==void 0)x=E;else if(x=L.isPointLight===!0?l:o,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0){const z=x.uuid,$=P.uuid;let I=c[z];I===void 0&&(I={},c[z]=I);let N=I[$];N===void 0&&(N=x.clone(),I[$]=N),x=N}if(x.visible=P.visible,x.wireframe=P.wireframe,y===_n?x.side=P.shadowSide!==null?P.shadowSide:P.side:x.side=P.shadowSide!==null?P.shadowSide:h[P.side],x.alphaMap=P.alphaMap,x.alphaTest=P.alphaTest,x.map=P.map,x.clipShadows=P.clipShadows,x.clippingPlanes=P.clippingPlanes,x.clipIntersection=P.clipIntersection,x.displacementMap=P.displacementMap,x.displacementScale=P.displacementScale,x.displacementBias=P.displacementBias,x.wireframeLinewidth=P.wireframeLinewidth,x.linewidth=P.linewidth,L.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const z=i.properties.get(x);z.light=L}return x}function T(A,P,L,y,x){if(A.visible===!1)return;if(A.layers.test(P.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&x===_n)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld);const $=e.update(A),I=A.material;if(Array.isArray(I)){const N=$.groups;for(let F=0,W=N.length;F<W;F++){const G=N[F],q=I[G.materialIndex];if(q&&q.visible){const Z=_(A,q,y,x);i.renderBufferDirect(L,null,$,Z,A,G)}}}else if(I.visible){const N=_(A,I,y,x);i.renderBufferDirect(L,null,$,N,A,null)}}const z=A.children;for(let $=0,I=z.length;$<I;$++)T(z[$],P,L,y,x)}}function ox(i,e,t){const n=t.isWebGL2;function r(){let D=!1;const pe=new bt;let V=null;const ue=new bt(0,0,0,0);return{setMask:function(_e){V!==_e&&!D&&(i.colorMask(_e,_e,_e,_e),V=_e)},setLocked:function(_e){D=_e},setClear:function(_e,Ze,lt,dt,zn){zn===!0&&(_e*=dt,Ze*=dt,lt*=dt),pe.set(_e,Ze,lt,dt),ue.equals(pe)===!1&&(i.clearColor(_e,Ze,lt,dt),ue.copy(pe))},reset:function(){D=!1,V=null,ue.set(-1,0,0,0)}}}function s(){let D=!1,pe=null,V=null,ue=null;return{setTest:function(_e){_e?Me(i.DEPTH_TEST):Ie(i.DEPTH_TEST)},setMask:function(_e){pe!==_e&&!D&&(i.depthMask(_e),pe=_e)},setFunc:function(_e){if(V!==_e){switch(_e){case Cp:i.depthFunc(i.NEVER);break;case Lp:i.depthFunc(i.ALWAYS);break;case Pp:i.depthFunc(i.LESS);break;case qs:i.depthFunc(i.LEQUAL);break;case Dp:i.depthFunc(i.EQUAL);break;case Ip:i.depthFunc(i.GEQUAL);break;case Up:i.depthFunc(i.GREATER);break;case Np:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}V=_e}},setLocked:function(_e){D=_e},setClear:function(_e){ue!==_e&&(i.clearDepth(_e),ue=_e)},reset:function(){D=!1,pe=null,V=null,ue=null}}}function a(){let D=!1,pe=null,V=null,ue=null,_e=null,Ze=null,lt=null,dt=null,zn=null;return{setTest:function(ct){D||(ct?Me(i.STENCIL_TEST):Ie(i.STENCIL_TEST))},setMask:function(ct){pe!==ct&&!D&&(i.stencilMask(ct),pe=ct)},setFunc:function(ct,tn,Rt){(V!==ct||ue!==tn||_e!==Rt)&&(i.stencilFunc(ct,tn,Rt),V=ct,ue=tn,_e=Rt)},setOp:function(ct,tn,Rt){(Ze!==ct||lt!==tn||dt!==Rt)&&(i.stencilOp(ct,tn,Rt),Ze=ct,lt=tn,dt=Rt)},setLocked:function(ct){D=ct},setClear:function(ct){zn!==ct&&(i.clearStencil(ct),zn=ct)},reset:function(){D=!1,pe=null,V=null,ue=null,_e=null,Ze=null,lt=null,dt=null,zn=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,h=new WeakMap;let d={},p={},g=new WeakMap,v=[],m=null,f=!1,b=null,_=null,T=null,A=null,P=null,L=null,y=null,x=!1,E=null,z=null,$=null,I=null,N=null;const F=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,G=0;const q=i.getParameter(i.VERSION);q.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(q)[1]),W=G>=1):q.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),W=G>=2);let Z=null,Q={};const de=i.getParameter(i.SCISSOR_BOX),k=i.getParameter(i.VIEWPORT),te=new bt().fromArray(de),ne=new bt().fromArray(k);function fe(D,pe,V,ue){const _e=new Uint8Array(4),Ze=i.createTexture();i.bindTexture(D,Ze),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let lt=0;lt<V;lt++)n&&(D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY)?i.texImage3D(pe,0,i.RGBA,1,1,ue,0,i.RGBA,i.UNSIGNED_BYTE,_e):i.texImage2D(pe+lt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,_e);return Ze}const ve={};ve[i.TEXTURE_2D]=fe(i.TEXTURE_2D,i.TEXTURE_2D,1),ve[i.TEXTURE_CUBE_MAP]=fe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(ve[i.TEXTURE_2D_ARRAY]=fe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ve[i.TEXTURE_3D]=fe(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Me(i.DEPTH_TEST),l.setFunc(qs),J(!1),Ae(na),Me(i.CULL_FACE),K(Un);function Me(D){d[D]!==!0&&(i.enable(D),d[D]=!0)}function Ie(D){d[D]!==!1&&(i.disable(D),d[D]=!1)}function Le(D,pe){return p[D]!==pe?(i.bindFramebuffer(D,pe),p[D]=pe,n&&(D===i.DRAW_FRAMEBUFFER&&(p[i.FRAMEBUFFER]=pe),D===i.FRAMEBUFFER&&(p[i.DRAW_FRAMEBUFFER]=pe)),!0):!1}function Ye(D,pe){let V=v,ue=!1;if(D)if(V=g.get(pe),V===void 0&&(V=[],g.set(pe,V)),D.isWebGLMultipleRenderTargets){const _e=D.texture;if(V.length!==_e.length||V[0]!==i.COLOR_ATTACHMENT0){for(let Ze=0,lt=_e.length;Ze<lt;Ze++)V[Ze]=i.COLOR_ATTACHMENT0+Ze;V.length=_e.length,ue=!0}}else V[0]!==i.COLOR_ATTACHMENT0&&(V[0]=i.COLOR_ATTACHMENT0,ue=!0);else V[0]!==i.BACK&&(V[0]=i.BACK,ue=!0);ue&&(t.isWebGL2?i.drawBuffers(V):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(V))}function Pe(D){return m!==D?(i.useProgram(D),m=D,!0):!1}const C={[Ri]:i.FUNC_ADD,[vp]:i.FUNC_SUBTRACT,[xp]:i.FUNC_REVERSE_SUBTRACT};if(n)C[oa]=i.MIN,C[aa]=i.MAX;else{const D=e.get("EXT_blend_minmax");D!==null&&(C[oa]=D.MIN_EXT,C[aa]=D.MAX_EXT)}const ae={[Mp]:i.ZERO,[Sp]:i.ONE,[yp]:i.SRC_COLOR,[nc]:i.SRC_ALPHA,[Rp]:i.SRC_ALPHA_SATURATE,[Ap]:i.DST_COLOR,[bp]:i.DST_ALPHA,[Ep]:i.ONE_MINUS_SRC_COLOR,[ic]:i.ONE_MINUS_SRC_ALPHA,[wp]:i.ONE_MINUS_DST_COLOR,[Tp]:i.ONE_MINUS_DST_ALPHA};function K(D,pe,V,ue,_e,Ze,lt,dt){if(D===Un){f===!0&&(Ie(i.BLEND),f=!1);return}if(f===!1&&(Me(i.BLEND),f=!0),D!==_p){if(D!==b||dt!==x){if((_!==Ri||P!==Ri)&&(i.blendEquation(i.FUNC_ADD),_=Ri,P=Ri),dt)switch(D){case Di:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.ONE,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case sa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Di:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ia:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ra:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case sa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}T=null,A=null,L=null,y=null,b=D,x=dt}return}_e=_e||pe,Ze=Ze||V,lt=lt||ue,(pe!==_||_e!==P)&&(i.blendEquationSeparate(C[pe],C[_e]),_=pe,P=_e),(V!==T||ue!==A||Ze!==L||lt!==y)&&(i.blendFuncSeparate(ae[V],ae[ue],ae[Ze],ae[lt]),T=V,A=ue,L=Ze,y=lt),b=D,x=!1}function se(D,pe){D.side===rn?Ie(i.CULL_FACE):Me(i.CULL_FACE);let V=D.side===It;pe&&(V=!V),J(V),D.blending===Di&&D.transparent===!1?K(Un):K(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.premultipliedAlpha),l.setFunc(D.depthFunc),l.setTest(D.depthTest),l.setMask(D.depthWrite),o.setMask(D.colorWrite);const ue=D.stencilWrite;c.setTest(ue),ue&&(c.setMask(D.stencilWriteMask),c.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),c.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),xe(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?Me(i.SAMPLE_ALPHA_TO_COVERAGE):Ie(i.SAMPLE_ALPHA_TO_COVERAGE)}function J(D){E!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),E=D)}function Ae(D){D!==pp?(Me(i.CULL_FACE),D!==z&&(D===na?i.cullFace(i.BACK):D===mp?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ie(i.CULL_FACE),z=D}function ge(D){D!==$&&(W&&i.lineWidth(D),$=D)}function xe(D,pe,V){D?(Me(i.POLYGON_OFFSET_FILL),(I!==pe||N!==V)&&(i.polygonOffset(pe,V),I=pe,N=V)):Ie(i.POLYGON_OFFSET_FILL)}function Ue(D){D?Me(i.SCISSOR_TEST):Ie(i.SCISSOR_TEST)}function We(D){D===void 0&&(D=i.TEXTURE0+F-1),Z!==D&&(i.activeTexture(D),Z=D)}function st(D,pe,V){V===void 0&&(Z===null?V=i.TEXTURE0+F-1:V=Z);let ue=Q[V];ue===void 0&&(ue={type:void 0,texture:void 0},Q[V]=ue),(ue.type!==D||ue.texture!==pe)&&(Z!==V&&(i.activeTexture(V),Z=V),i.bindTexture(D,pe||ve[D]),ue.type=D,ue.texture=pe)}function w(){const D=Q[Z];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function M(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function X(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function re(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function R(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ee(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ie(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function H(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Re(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(D){te.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),te.copy(D))}function be(D){ne.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),ne.copy(D))}function Se(D,pe){let V=h.get(pe);V===void 0&&(V=new WeakMap,h.set(pe,V));let ue=V.get(D);ue===void 0&&(ue=i.getUniformBlockIndex(pe,D.name),V.set(D,ue))}function Ne(D,pe){const ue=h.get(pe).get(D);u.get(pe)!==ue&&(i.uniformBlockBinding(pe,ue,D.__bindingPointIndex),u.set(pe,ue))}function qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},Z=null,Q={},p={},g=new WeakMap,v=[],m=null,f=!1,b=null,_=null,T=null,A=null,P=null,L=null,y=null,x=!1,E=null,z=null,$=null,I=null,N=null,te.set(0,0,i.canvas.width,i.canvas.height),ne.set(0,0,i.canvas.width,i.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Me,disable:Ie,bindFramebuffer:Le,drawBuffers:Ye,useProgram:Pe,setBlending:K,setMaterial:se,setFlipSided:J,setCullFace:Ae,setLineWidth:ge,setPolygonOffset:xe,setScissorTest:Ue,activeTexture:We,bindTexture:st,unbindTexture:w,compressedTexImage2D:M,compressedTexImage3D:X,texImage2D:Ee,texImage3D:Re,updateUBOMapping:Se,uniformBlockBinding:Ne,texStorage2D:ie,texStorage3D:H,texSubImage2D:oe,texSubImage3D:re,compressedTexSubImage2D:R,compressedTexSubImage3D:ee,scissor:we,viewport:be,reset:qe}}function ax(i,e,t,n,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,h=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let v;const m=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(w,M){return f?new OffscreenCanvas(w,M):nr("canvas")}function _(w,M,X,oe){let re=1;if((w.width>oe||w.height>oe)&&(re=oe/Math.max(w.width,w.height)),re<1||M===!0)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap){const R=M?Js:Math.floor,ee=R(re*w.width),ie=R(re*w.height);v===void 0&&(v=b(ee,ie));const H=X?b(ee,ie):v;return H.width=ee,H.height=ie,H.getContext("2d").drawImage(w,0,0,ee,ie),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+w.width+"x"+w.height+") to ("+ee+"x"+ie+")."),H}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+w.width+"x"+w.height+")."),w;return w}function T(w){return Ua(w.width)&&Ua(w.height)}function A(w){return o?!1:w.wrapS!==Zt||w.wrapT!==Zt||w.minFilter!==Pt&&w.minFilter!==Gt}function P(w,M){return w.generateMipmaps&&M&&w.minFilter!==Pt&&w.minFilter!==Gt}function L(w){i.generateMipmap(w)}function y(w,M,X,oe,re=!1){if(o===!1)return M;if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let R=M;return M===i.RED&&(X===i.FLOAT&&(R=i.R32F),X===i.HALF_FLOAT&&(R=i.R16F),X===i.UNSIGNED_BYTE&&(R=i.R8)),M===i.RG&&(X===i.FLOAT&&(R=i.RG32F),X===i.HALF_FLOAT&&(R=i.RG16F),X===i.UNSIGNED_BYTE&&(R=i.RG8)),M===i.RGBA&&(X===i.FLOAT&&(R=i.RGBA32F),X===i.HALF_FLOAT&&(R=i.RGBA16F),X===i.UNSIGNED_BYTE&&(R=oe===ke&&re===!1?i.SRGB8_ALPHA8:i.RGBA8),X===i.UNSIGNED_SHORT_4_4_4_4&&(R=i.RGBA4),X===i.UNSIGNED_SHORT_5_5_5_1&&(R=i.RGB5_A1)),(R===i.R16F||R===i.R32F||R===i.RG16F||R===i.RG32F||R===i.RGBA16F||R===i.RGBA32F)&&e.get("EXT_color_buffer_float"),R}function x(w,M,X){return P(w,X)===!0||w.isFramebufferTexture&&w.minFilter!==Pt&&w.minFilter!==Gt?Math.log2(Math.max(M.width,M.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?M.mipmaps.length:1}function E(w){return w===Pt||w===la||w===us?i.NEAREST:i.LINEAR}function z(w){const M=w.target;M.removeEventListener("dispose",z),I(M),M.isVideoTexture&&g.delete(M)}function $(w){const M=w.target;M.removeEventListener("dispose",$),F(M)}function I(w){const M=n.get(w);if(M.__webglInit===void 0)return;const X=w.source,oe=m.get(X);if(oe){const re=oe[M.__cacheKey];re.usedTimes--,re.usedTimes===0&&N(w),Object.keys(oe).length===0&&m.delete(X)}n.remove(w)}function N(w){const M=n.get(w);i.deleteTexture(M.__webglTexture);const X=w.source,oe=m.get(X);delete oe[M.__cacheKey],a.memory.textures--}function F(w){const M=w.texture,X=n.get(w),oe=n.get(M);if(oe.__webglTexture!==void 0&&(i.deleteTexture(oe.__webglTexture),a.memory.textures--),w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let re=0;re<6;re++)i.deleteFramebuffer(X.__webglFramebuffer[re]),X.__webglDepthbuffer&&i.deleteRenderbuffer(X.__webglDepthbuffer[re]);else{if(i.deleteFramebuffer(X.__webglFramebuffer),X.__webglDepthbuffer&&i.deleteRenderbuffer(X.__webglDepthbuffer),X.__webglMultisampledFramebuffer&&i.deleteFramebuffer(X.__webglMultisampledFramebuffer),X.__webglColorRenderbuffer)for(let re=0;re<X.__webglColorRenderbuffer.length;re++)X.__webglColorRenderbuffer[re]&&i.deleteRenderbuffer(X.__webglColorRenderbuffer[re]);X.__webglDepthRenderbuffer&&i.deleteRenderbuffer(X.__webglDepthRenderbuffer)}if(w.isWebGLMultipleRenderTargets)for(let re=0,R=M.length;re<R;re++){const ee=n.get(M[re]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),a.memory.textures--),n.remove(M[re])}n.remove(M),n.remove(w)}let W=0;function G(){W=0}function q(){const w=W;return w>=l&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+l),W+=1,w}function Z(w){const M=[];return M.push(w.wrapS),M.push(w.wrapT),M.push(w.wrapR||0),M.push(w.magFilter),M.push(w.minFilter),M.push(w.anisotropy),M.push(w.internalFormat),M.push(w.format),M.push(w.type),M.push(w.generateMipmaps),M.push(w.premultiplyAlpha),M.push(w.flipY),M.push(w.unpackAlignment),M.push(w.colorSpace),M.join()}function Q(w,M){const X=n.get(w);if(w.isVideoTexture&&We(w),w.isRenderTargetTexture===!1&&w.version>0&&X.__version!==w.version){const oe=w.image;if(oe===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(oe.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Le(X,w,M);return}}t.bindTexture(i.TEXTURE_2D,X.__webglTexture,i.TEXTURE0+M)}function de(w,M){const X=n.get(w);if(w.version>0&&X.__version!==w.version){Le(X,w,M);return}t.bindTexture(i.TEXTURE_2D_ARRAY,X.__webglTexture,i.TEXTURE0+M)}function k(w,M){const X=n.get(w);if(w.version>0&&X.__version!==w.version){Le(X,w,M);return}t.bindTexture(i.TEXTURE_3D,X.__webglTexture,i.TEXTURE0+M)}function te(w,M){const X=n.get(w);if(w.version>0&&X.__version!==w.version){Ye(X,w,M);return}t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture,i.TEXTURE0+M)}const ne={[Ys]:i.REPEAT,[Zt]:i.CLAMP_TO_EDGE,[js]:i.MIRRORED_REPEAT},fe={[Pt]:i.NEAREST,[la]:i.NEAREST_MIPMAP_NEAREST,[us]:i.NEAREST_MIPMAP_LINEAR,[Gt]:i.LINEAR,[Vp]:i.LINEAR_MIPMAP_NEAREST,[er]:i.LINEAR_MIPMAP_LINEAR},ve={[im]:i.NEVER,[um]:i.ALWAYS,[rm]:i.LESS,[om]:i.LEQUAL,[sm]:i.EQUAL,[cm]:i.GEQUAL,[am]:i.GREATER,[lm]:i.NOTEQUAL};function Me(w,M,X){if(X?(i.texParameteri(w,i.TEXTURE_WRAP_S,ne[M.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,ne[M.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,ne[M.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,fe[M.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,fe[M.minFilter])):(i.texParameteri(w,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(w,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(M.wrapS!==Zt||M.wrapT!==Zt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(w,i.TEXTURE_MAG_FILTER,E(M.magFilter)),i.texParameteri(w,i.TEXTURE_MIN_FILTER,E(M.minFilter)),M.minFilter!==Pt&&M.minFilter!==Gt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),M.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,ve[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const oe=e.get("EXT_texture_filter_anisotropic");if(M.magFilter===Pt||M.minFilter!==us&&M.minFilter!==er||M.type===In&&e.has("OES_texture_float_linear")===!1||o===!1&&M.type===tr&&e.has("OES_texture_half_float_linear")===!1)return;(M.anisotropy>1||n.get(M).__currentAnisotropy)&&(i.texParameterf(w,oe.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),n.get(M).__currentAnisotropy=M.anisotropy)}}function Ie(w,M){let X=!1;w.__webglInit===void 0&&(w.__webglInit=!0,M.addEventListener("dispose",z));const oe=M.source;let re=m.get(oe);re===void 0&&(re={},m.set(oe,re));const R=Z(M);if(R!==w.__cacheKey){re[R]===void 0&&(re[R]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,X=!0),re[R].usedTimes++;const ee=re[w.__cacheKey];ee!==void 0&&(re[w.__cacheKey].usedTimes--,ee.usedTimes===0&&N(M)),w.__cacheKey=R,w.__webglTexture=re[R].texture}return X}function Le(w,M,X){let oe=i.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(oe=i.TEXTURE_2D_ARRAY),M.isData3DTexture&&(oe=i.TEXTURE_3D);const re=Ie(w,M),R=M.source;t.bindTexture(oe,w.__webglTexture,i.TEXTURE0+X);const ee=n.get(R);if(R.version!==ee.__version||re===!0){t.activeTexture(i.TEXTURE0+X),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const ie=A(M)&&T(M.image)===!1;let H=_(M.image,ie,!1,u);H=st(M,H);const Ee=T(H)||o,Re=s.convert(M.format,M.colorSpace);let we=s.convert(M.type),be=y(M.internalFormat,Re,we,M.colorSpace);Me(oe,M,Ee);let Se;const Ne=M.mipmaps,qe=o&&M.isVideoTexture!==!0,D=ee.__version===void 0||re===!0,pe=x(M,H,Ee);if(M.isDepthTexture)be=i.DEPTH_COMPONENT,o?M.type===In?be=i.DEPTH_COMPONENT32F:M.type===Dn?be=i.DEPTH_COMPONENT24:M.type===Zn?be=i.DEPTH24_STENCIL8:be=i.DEPTH_COMPONENT16:M.type===In&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),M.format===Jn&&be===i.DEPTH_COMPONENT&&M.type!==xo&&M.type!==Dn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),M.type=Dn,we=s.convert(M.type)),M.format===Bi&&be===i.DEPTH_COMPONENT&&(be=i.DEPTH_STENCIL,M.type!==Zn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),M.type=Zn,we=s.convert(M.type))),D&&(qe?t.texStorage2D(i.TEXTURE_2D,1,be,H.width,H.height):t.texImage2D(i.TEXTURE_2D,0,be,H.width,H.height,0,Re,we,null));else if(M.isDataTexture)if(Ne.length>0&&Ee){qe&&D&&t.texStorage2D(i.TEXTURE_2D,pe,be,Ne[0].width,Ne[0].height);for(let V=0,ue=Ne.length;V<ue;V++)Se=Ne[V],qe?t.texSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,Re,we,Se.data):t.texImage2D(i.TEXTURE_2D,V,be,Se.width,Se.height,0,Re,we,Se.data);M.generateMipmaps=!1}else qe?(D&&t.texStorage2D(i.TEXTURE_2D,pe,be,H.width,H.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,H.width,H.height,Re,we,H.data)):t.texImage2D(i.TEXTURE_2D,0,be,H.width,H.height,0,Re,we,H.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){qe&&D&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,be,Ne[0].width,Ne[0].height,H.depth);for(let V=0,ue=Ne.length;V<ue;V++)Se=Ne[V],M.format!==Jt?Re!==null?qe?t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Se.width,Se.height,H.depth,Re,Se.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,V,be,Se.width,Se.height,H.depth,0,Se.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):qe?t.texSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,Se.width,Se.height,H.depth,Re,we,Se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,V,be,Se.width,Se.height,H.depth,0,Re,we,Se.data)}else{qe&&D&&t.texStorage2D(i.TEXTURE_2D,pe,be,Ne[0].width,Ne[0].height);for(let V=0,ue=Ne.length;V<ue;V++)Se=Ne[V],M.format!==Jt?Re!==null?qe?t.compressedTexSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,Re,Se.data):t.compressedTexImage2D(i.TEXTURE_2D,V,be,Se.width,Se.height,0,Se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):qe?t.texSubImage2D(i.TEXTURE_2D,V,0,0,Se.width,Se.height,Re,we,Se.data):t.texImage2D(i.TEXTURE_2D,V,be,Se.width,Se.height,0,Re,we,Se.data)}else if(M.isDataArrayTexture)qe?(D&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,be,H.width,H.height,H.depth),t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,H.width,H.height,H.depth,Re,we,H.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,be,H.width,H.height,H.depth,0,Re,we,H.data);else if(M.isData3DTexture)qe?(D&&t.texStorage3D(i.TEXTURE_3D,pe,be,H.width,H.height,H.depth),t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,H.width,H.height,H.depth,Re,we,H.data)):t.texImage3D(i.TEXTURE_3D,0,be,H.width,H.height,H.depth,0,Re,we,H.data);else if(M.isFramebufferTexture){if(D)if(qe)t.texStorage2D(i.TEXTURE_2D,pe,be,H.width,H.height);else{let V=H.width,ue=H.height;for(let _e=0;_e<pe;_e++)t.texImage2D(i.TEXTURE_2D,_e,be,V,ue,0,Re,we,null),V>>=1,ue>>=1}}else if(Ne.length>0&&Ee){qe&&D&&t.texStorage2D(i.TEXTURE_2D,pe,be,Ne[0].width,Ne[0].height);for(let V=0,ue=Ne.length;V<ue;V++)Se=Ne[V],qe?t.texSubImage2D(i.TEXTURE_2D,V,0,0,Re,we,Se):t.texImage2D(i.TEXTURE_2D,V,be,Re,we,Se);M.generateMipmaps=!1}else qe?(D&&t.texStorage2D(i.TEXTURE_2D,pe,be,H.width,H.height),t.texSubImage2D(i.TEXTURE_2D,0,0,0,Re,we,H)):t.texImage2D(i.TEXTURE_2D,0,be,Re,we,H);P(M,Ee)&&L(oe),ee.__version=R.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function Ye(w,M,X){if(M.image.length!==6)return;const oe=Ie(w,M),re=M.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+X);const R=n.get(re);if(re.version!==R.__version||oe===!0){t.activeTexture(i.TEXTURE0+X),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.NONE);const ee=M.isCompressedTexture||M.image[0].isCompressedTexture,ie=M.image[0]&&M.image[0].isDataTexture,H=[];for(let V=0;V<6;V++)!ee&&!ie?H[V]=_(M.image[V],!1,!0,c):H[V]=ie?M.image[V].image:M.image[V],H[V]=st(M,H[V]);const Ee=H[0],Re=T(Ee)||o,we=s.convert(M.format,M.colorSpace),be=s.convert(M.type),Se=y(M.internalFormat,we,be,M.colorSpace),Ne=o&&M.isVideoTexture!==!0,qe=R.__version===void 0||oe===!0;let D=x(M,Ee,Re);Me(i.TEXTURE_CUBE_MAP,M,Re);let pe;if(ee){Ne&&qe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,D,Se,Ee.width,Ee.height);for(let V=0;V<6;V++){pe=H[V].mipmaps;for(let ue=0;ue<pe.length;ue++){const _e=pe[ue];M.format!==Jt?we!==null?Ne?t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue,0,0,_e.width,_e.height,we,_e.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue,Se,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue,0,0,_e.width,_e.height,we,be,_e.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue,Se,_e.width,_e.height,0,we,be,_e.data)}}}else{pe=M.mipmaps,Ne&&qe&&(pe.length>0&&D++,t.texStorage2D(i.TEXTURE_CUBE_MAP,D,Se,H[0].width,H[0].height));for(let V=0;V<6;V++)if(ie){Ne?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,0,0,H[V].width,H[V].height,we,be,H[V].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,Se,H[V].width,H[V].height,0,we,be,H[V].data);for(let ue=0;ue<pe.length;ue++){const Ze=pe[ue].image[V].image;Ne?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue+1,0,0,Ze.width,Ze.height,we,be,Ze.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue+1,Se,Ze.width,Ze.height,0,we,be,Ze.data)}}else{Ne?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,0,0,we,be,H[V]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,Se,we,be,H[V]);for(let ue=0;ue<pe.length;ue++){const _e=pe[ue];Ne?t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue+1,0,0,we,be,_e.image[V]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+V,ue+1,Se,we,be,_e.image[V])}}}P(M,Re)&&L(i.TEXTURE_CUBE_MAP),R.__version=re.version,M.onUpdate&&M.onUpdate(M)}w.__version=M.version}function Pe(w,M,X,oe,re){const R=s.convert(X.format,X.colorSpace),ee=s.convert(X.type),ie=y(X.internalFormat,R,ee,X.colorSpace);n.get(M).__hasExternalTextures||(re===i.TEXTURE_3D||re===i.TEXTURE_2D_ARRAY?t.texImage3D(re,0,ie,M.width,M.height,M.depth,0,R,ee,null):t.texImage2D(re,0,ie,M.width,M.height,0,R,ee,null)),t.bindFramebuffer(i.FRAMEBUFFER,w),Ue(M)?d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,oe,re,n.get(X).__webglTexture,0,xe(M)):(re===i.TEXTURE_2D||re>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&re<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,oe,re,n.get(X).__webglTexture,0),t.bindFramebuffer(i.FRAMEBUFFER,null)}function C(w,M,X){if(i.bindRenderbuffer(i.RENDERBUFFER,w),M.depthBuffer&&!M.stencilBuffer){let oe=i.DEPTH_COMPONENT16;if(X||Ue(M)){const re=M.depthTexture;re&&re.isDepthTexture&&(re.type===In?oe=i.DEPTH_COMPONENT32F:re.type===Dn&&(oe=i.DEPTH_COMPONENT24));const R=xe(M);Ue(M)?d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,R,oe,M.width,M.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,R,oe,M.width,M.height)}else i.renderbufferStorage(i.RENDERBUFFER,oe,M.width,M.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,w)}else if(M.depthBuffer&&M.stencilBuffer){const oe=xe(M);X&&Ue(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,i.DEPTH24_STENCIL8,M.width,M.height):Ue(M)?d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,i.DEPTH24_STENCIL8,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,w)}else{const oe=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let re=0;re<oe.length;re++){const R=oe[re],ee=s.convert(R.format,R.colorSpace),ie=s.convert(R.type),H=y(R.internalFormat,ee,ie,R.colorSpace),Ee=xe(M);X&&Ue(M)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,H,M.width,M.height):Ue(M)?d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ee,H,M.width,M.height):i.renderbufferStorage(i.RENDERBUFFER,H,M.width,M.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ae(w,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(M.depthTexture).__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Q(M.depthTexture,0);const oe=n.get(M.depthTexture).__webglTexture,re=xe(M);if(M.depthTexture.format===Jn)Ue(M)?d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,oe,0,re):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,oe,0);else if(M.depthTexture.format===Bi)Ue(M)?d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,oe,0,re):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,oe,0);else throw new Error("Unknown depthTexture format")}function K(w){const M=n.get(w),X=w.isWebGLCubeRenderTarget===!0;if(w.depthTexture&&!M.__autoAllocateDepthBuffer){if(X)throw new Error("target.depthTexture not supported in Cube render targets");ae(M.__webglFramebuffer,w)}else if(X){M.__webglDepthbuffer=[];for(let oe=0;oe<6;oe++)t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer[oe]),M.__webglDepthbuffer[oe]=i.createRenderbuffer(),C(M.__webglDepthbuffer[oe],w,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer=i.createRenderbuffer(),C(M.__webglDepthbuffer,w,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function se(w,M,X){const oe=n.get(w);M!==void 0&&Pe(oe.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D),X!==void 0&&K(w)}function J(w){const M=w.texture,X=n.get(w),oe=n.get(M);w.addEventListener("dispose",$),w.isWebGLMultipleRenderTargets!==!0&&(oe.__webglTexture===void 0&&(oe.__webglTexture=i.createTexture()),oe.__version=M.version,a.memory.textures++);const re=w.isWebGLCubeRenderTarget===!0,R=w.isWebGLMultipleRenderTargets===!0,ee=T(w)||o;if(re){X.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)X.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(X.__webglFramebuffer=i.createFramebuffer(),R)if(r.drawBuffers){const ie=w.texture;for(let H=0,Ee=ie.length;H<Ee;H++){const Re=n.get(ie[H]);Re.__webglTexture===void 0&&(Re.__webglTexture=i.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&w.samples>0&&Ue(w)===!1){const ie=R?M:[M];X.__webglMultisampledFramebuffer=i.createFramebuffer(),X.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,X.__webglMultisampledFramebuffer);for(let H=0;H<ie.length;H++){const Ee=ie[H];X.__webglColorRenderbuffer[H]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,X.__webglColorRenderbuffer[H]);const Re=s.convert(Ee.format,Ee.colorSpace),we=s.convert(Ee.type),be=y(Ee.internalFormat,Re,we,Ee.colorSpace,w.isXRRenderTarget===!0),Se=xe(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Se,be,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+H,i.RENDERBUFFER,X.__webglColorRenderbuffer[H])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(X.__webglDepthRenderbuffer=i.createRenderbuffer(),C(X.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(re){t.bindTexture(i.TEXTURE_CUBE_MAP,oe.__webglTexture),Me(i.TEXTURE_CUBE_MAP,M,ee);for(let ie=0;ie<6;ie++)Pe(X.__webglFramebuffer[ie],w,M,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie);P(M,ee)&&L(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(R){const ie=w.texture;for(let H=0,Ee=ie.length;H<Ee;H++){const Re=ie[H],we=n.get(Re);t.bindTexture(i.TEXTURE_2D,we.__webglTexture),Me(i.TEXTURE_2D,Re,ee),Pe(X.__webglFramebuffer,w,Re,i.COLOR_ATTACHMENT0+H,i.TEXTURE_2D),P(Re,ee)&&L(i.TEXTURE_2D)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(o?ie=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ie,oe.__webglTexture),Me(ie,M,ee),Pe(X.__webglFramebuffer,w,M,i.COLOR_ATTACHMENT0,ie),P(M,ee)&&L(ie),t.unbindTexture()}w.depthBuffer&&K(w)}function Ae(w){const M=T(w)||o,X=w.isWebGLMultipleRenderTargets===!0?w.texture:[w.texture];for(let oe=0,re=X.length;oe<re;oe++){const R=X[oe];if(P(R,M)){const ee=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,ie=n.get(R).__webglTexture;t.bindTexture(ee,ie),L(ee),t.unbindTexture()}}}function ge(w){if(o&&w.samples>0&&Ue(w)===!1){const M=w.isWebGLMultipleRenderTargets?w.texture:[w.texture],X=w.width,oe=w.height;let re=i.COLOR_BUFFER_BIT;const R=[],ee=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=n.get(w),H=w.isWebGLMultipleRenderTargets===!0;if(H)for(let Ee=0;Ee<M.length;Ee++)t.bindFramebuffer(i.FRAMEBUFFER,ie.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ie.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ie.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ie.__webglFramebuffer);for(let Ee=0;Ee<M.length;Ee++){R.push(i.COLOR_ATTACHMENT0+Ee),w.depthBuffer&&R.push(ee);const Re=ie.__ignoreDepthValues!==void 0?ie.__ignoreDepthValues:!1;if(Re===!1&&(w.depthBuffer&&(re|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&(re|=i.STENCIL_BUFFER_BIT)),H&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ie.__webglColorRenderbuffer[Ee]),Re===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[ee]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[ee])),H){const we=n.get(M[Ee]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,we,0)}i.blitFramebuffer(0,0,X,oe,0,0,X,oe,re,i.NEAREST),p&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,R)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),H)for(let Ee=0;Ee<M.length;Ee++){t.bindFramebuffer(i.FRAMEBUFFER,ie.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,ie.__webglColorRenderbuffer[Ee]);const Re=n.get(M[Ee]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ie.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,Re,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ie.__webglMultisampledFramebuffer)}}function xe(w){return Math.min(h,w.samples)}function Ue(w){const M=n.get(w);return o&&w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function We(w){const M=a.render.frame;g.get(w)!==M&&(g.set(w,M),w.update())}function st(w,M){const X=w.colorSpace,oe=w.format,re=w.type;return w.isCompressedTexture===!0||w.format===Ks||X!==on&&X!==ei&&(X===ke?o===!1?e.has("EXT_sRGB")===!0&&oe===Jt?(w.format=Ks,w.minFilter=Gt,w.generateMipmaps=!1):M=gc.sRGBToLinear(M):(oe!==Jt||re!==Nn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",X)),M}this.allocateTextureUnit=q,this.resetTextureUnits=G,this.setTexture2D=Q,this.setTexture2DArray=de,this.setTexture3D=k,this.setTextureCube=te,this.rebindTextures=se,this.setupRenderTarget=J,this.updateRenderTargetMipmap=Ae,this.updateMultisampleRenderTarget=ge,this.setupDepthRenderbuffer=K,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=Ue}function lx(i,e,t){const n=t.isWebGL2;function r(s,a=ei){let o;if(s===Nn)return i.UNSIGNED_BYTE;if(s===ac)return i.UNSIGNED_SHORT_4_4_4_4;if(s===lc)return i.UNSIGNED_SHORT_5_5_5_1;if(s===Wp)return i.BYTE;if(s===Xp)return i.SHORT;if(s===xo)return i.UNSIGNED_SHORT;if(s===oc)return i.INT;if(s===Dn)return i.UNSIGNED_INT;if(s===In)return i.FLOAT;if(s===tr)return n?i.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===qp)return i.ALPHA;if(s===Jt)return i.RGBA;if(s===$p)return i.LUMINANCE;if(s===Yp)return i.LUMINANCE_ALPHA;if(s===Jn)return i.DEPTH_COMPONENT;if(s===Bi)return i.DEPTH_STENCIL;if(s===Ks)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===jp)return i.RED;if(s===cc)return i.RED_INTEGER;if(s===Kp)return i.RG;if(s===uc)return i.RG_INTEGER;if(s===hc)return i.RGBA_INTEGER;if(s===hs||s===ds||s===fs||s===ps)if(a===ke)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===hs)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===ds)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===fs)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===ps)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===hs)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===ds)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===fs)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===ps)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===ca||s===ua||s===ha||s===da)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===ca)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===ua)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===ha)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===da)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Zp)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===fa||s===pa)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===fa)return a===ke?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===pa)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ma||s===ga||s===_a||s===va||s===xa||s===Ma||s===Sa||s===ya||s===Ea||s===ba||s===Ta||s===Aa||s===wa||s===Ra)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===ma)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===ga)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===_a)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===va)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===xa)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ma)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Sa)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===ya)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ea)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ba)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Ta)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Aa)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===wa)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Ra)return a===ke?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===ms)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===ms)return a===ke?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT}else return null;if(s===Jp||s===Ca||s===La||s===Pa)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===ms)return o.COMPRESSED_RED_RGTC1_EXT;if(s===Ca)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===La)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Pa)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Zn?n?i.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class cx extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Or extends zt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const ux={type:"move"};class zs{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Or,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Or,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Or,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const v of e.hand.values()){const m=t.getJointPose(v,n),f=this._getHandJoint(c,v);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const u=c.joints["index-finger-tip"],h=c.joints["thumb-tip"],d=u.position.distanceTo(h.position),p=.02,g=.005;c.inputState.pinching&&d>p+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=p-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(ux)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Or;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}class hx extends Ut{constructor(e,t,n,r,s,a,o,l,c,u){if(u=u!==void 0?u:Jn,u!==Jn&&u!==Bi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Jn&&(n=Dn),n===void 0&&u===Bi&&(n=Zn),super(null,r,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Pt,this.minFilter=l!==void 0?l:Pt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}class dx extends li{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,d=null,p=null,g=null;const v=t.getContextAttributes();let m=null,f=null;const b=[],_=[];let T=null;const A=new Vt;A.layers.enable(1),A.viewport=new bt;const P=new Vt;P.layers.enable(2),P.viewport=new bt;const L=[A,P],y=new cx;y.layers.enable(1),y.layers.enable(2);let x=null,E=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getCamera=function(){},this.setUserCamera=function(k){T=k},this.getController=function(k){let te=b[k];return te===void 0&&(te=new zs,b[k]=te),te.getTargetRaySpace()},this.getControllerGrip=function(k){let te=b[k];return te===void 0&&(te=new zs,b[k]=te),te.getGripSpace()},this.getHand=function(k){let te=b[k];return te===void 0&&(te=new zs,b[k]=te),te.getHandSpace()};function z(k){const te=_.indexOf(k.inputSource);if(te===-1)return;const ne=b[te];ne!==void 0&&(ne.update(k.inputSource,k.frame,c||a),ne.dispatchEvent({type:k.type,data:k.inputSource}))}function $(){r.removeEventListener("select",z),r.removeEventListener("selectstart",z),r.removeEventListener("selectend",z),r.removeEventListener("squeeze",z),r.removeEventListener("squeezestart",z),r.removeEventListener("squeezeend",z),r.removeEventListener("end",$),r.removeEventListener("inputsourceschange",I);for(let k=0;k<b.length;k++){const te=_[k];te!==null&&(_[k]=null,b[k].disconnect(te))}x=null,E=null,e.setRenderTarget(m),p=null,d=null,h=null,r=null,f=null,de.stop(),n.isPresenting=!1,n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){s=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){o=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(k){c=k},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(k){if(r=k,r!==null){if(m=e.getRenderTarget(),r.addEventListener("select",z),r.addEventListener("selectstart",z),r.addEventListener("selectend",z),r.addEventListener("squeeze",z),r.addEventListener("squeezestart",z),r.addEventListener("squeezeend",z),r.addEventListener("end",$),r.addEventListener("inputsourceschange",I),v.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const te={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,te),r.updateRenderState({baseLayer:p}),f=new ti(p.framebufferWidth,p.framebufferHeight,{format:Jt,type:Nn,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let te=null,ne=null,fe=null;v.depth&&(fe=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,te=v.stencil?Bi:Jn,ne=v.stencil?Zn:Dn);const ve={colorFormat:t.RGBA8,depthFormat:fe,scaleFactor:s};h=new XRWebGLBinding(r,t),d=h.createProjectionLayer(ve),r.updateRenderState({layers:[d]}),f=new ti(d.textureWidth,d.textureHeight,{format:Jt,type:Nn,depthTexture:new hx(d.textureWidth,d.textureHeight,ne,void 0,void 0,void 0,void 0,void 0,void 0,te),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const Me=e.properties.get(f);Me.__ignoreDepthValues=d.ignoreDepthValues}f.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),de.setContext(r),de.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function I(k){for(let te=0;te<k.removed.length;te++){const ne=k.removed[te],fe=_.indexOf(ne);fe>=0&&(_[fe]=null,b[fe].disconnect(ne))}for(let te=0;te<k.added.length;te++){const ne=k.added[te];let fe=_.indexOf(ne);if(fe===-1){for(let Me=0;Me<b.length;Me++)if(Me>=_.length){_.push(ne),fe=Me;break}else if(_[Me]===null){_[Me]=ne,fe=Me;break}if(fe===-1)break}const ve=b[fe];ve&&ve.connect(ne)}}const N=new U,F=new U;function W(k,te,ne){N.setFromMatrixPosition(te.matrixWorld),F.setFromMatrixPosition(ne.matrixWorld);const fe=N.distanceTo(F),ve=te.projectionMatrix.elements,Me=ne.projectionMatrix.elements,Ie=ve[14]/(ve[10]-1),Le=ve[14]/(ve[10]+1),Ye=(ve[9]+1)/ve[5],Pe=(ve[9]-1)/ve[5],C=(ve[8]-1)/ve[0],ae=(Me[8]+1)/Me[0],K=Ie*C,se=Ie*ae,J=fe/(-C+ae),Ae=J*-C;te.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(Ae),k.translateZ(J),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert();const ge=Ie+J,xe=Le+J,Ue=K-Ae,We=se+(fe-Ae),st=Ye*Le/xe*ge,w=Pe*Le/xe*ge;k.projectionMatrix.makePerspective(Ue,We,st,w,ge,xe),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}function G(k,te){te===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(te.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCameraXR=function(k){if(r===null)return k;T&&(k=T),y.near=P.near=A.near=k.near,y.far=P.far=A.far=k.far,(x!==y.near||E!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),x=y.near,E=y.far);const te=k.parent,ne=y.cameras;G(y,te);for(let fe=0;fe<ne.length;fe++)G(ne[fe],te);return ne.length===2?W(y,A,P):y.projectionMatrix.copy(A.projectionMatrix),T&&q(y,te),y};function q(k,te){const ne=T;te===null?ne.matrix.copy(k.matrixWorld):(ne.matrix.copy(te.matrixWorld),ne.matrix.invert(),ne.matrix.multiply(k.matrixWorld)),ne.matrix.decompose(ne.position,ne.quaternion,ne.scale),ne.updateMatrixWorld(!0);const fe=ne.children;for(let ve=0,Me=fe.length;ve<Me;ve++)fe[ve].updateMatrixWorld(!0);ne.projectionMatrix.copy(k.projectionMatrix),ne.projectionMatrixInverse.copy(k.projectionMatrixInverse),ne.isPerspectiveCamera&&(ne.fov=Zs*2*Math.atan(1/ne.projectionMatrix.elements[5]),ne.zoom=1)}this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(k){l=k,d!==null&&(d.fixedFoveation=k),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=k)};let Z=null;function Q(k,te){if(u=te.getViewerPose(c||a),g=te,u!==null){const ne=u.views;p!==null&&(e.setRenderTargetFramebuffer(f,p.framebuffer),e.setRenderTarget(f));let fe=!1;ne.length!==y.cameras.length&&(y.cameras.length=0,fe=!0);for(let ve=0;ve<ne.length;ve++){const Me=ne[ve];let Ie=null;if(p!==null)Ie=p.getViewport(Me);else{const Ye=h.getViewSubImage(d,Me);Ie=Ye.viewport,ve===0&&(e.setRenderTargetTextures(f,Ye.colorTexture,d.ignoreDepthValues?void 0:Ye.depthStencilTexture),e.setRenderTarget(f))}let Le=L[ve];Le===void 0&&(Le=new Vt,Le.layers.enable(ve),Le.viewport=new bt,L[ve]=Le),Le.matrix.fromArray(Me.transform.matrix),Le.matrix.decompose(Le.position,Le.quaternion,Le.scale),Le.projectionMatrix.fromArray(Me.projectionMatrix),Le.projectionMatrixInverse.copy(Le.projectionMatrix).invert(),Le.viewport.set(Ie.x,Ie.y,Ie.width,Ie.height),ve===0&&(y.matrix.copy(Le.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),fe===!0&&y.cameras.push(Le)}}for(let ne=0;ne<b.length;ne++){const fe=_[ne],ve=b[ne];fe!==null&&ve!==void 0&&ve.update(fe,te,c||a)}Z&&Z(k,te),te.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:te}),g=null}const de=new Rc;de.setAnimationLoop(Q),this.setAnimationLoop=function(k){Z=k},this.dispose=function(){}}}function fx(i,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,bc(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,b,_,T){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(m,f):f.isMeshToonMaterial?(s(m,f),h(m,f)):f.isMeshPhongMaterial?(s(m,f),u(m,f)):f.isMeshStandardMaterial?(s(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,T)):f.isMeshMatcapMaterial?(s(m,f),g(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),v(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,b,_):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===It&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===It&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const b=e.get(f).envMap;if(b&&(m.envMap.value=b,m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap){m.lightMap.value=f.lightMap;const _=i.useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=f.lightMapIntensity*_,t(f.lightMap,m.lightMapTransform)}f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,b,_){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*b,m.scale.value=_*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function h(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),e.get(f).envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,b){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===It&&m.clearcoatNormalScale.value.negate())),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const b=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function px(i,e,t,n){let r={},s={},a=[];const o=t.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(b,_){const T=_.program;n.uniformBlockBinding(b,T)}function c(b,_){let T=r[b.id];T===void 0&&(g(b),T=u(b),r[b.id]=T,b.addEventListener("dispose",m));const A=_.program;n.updateUBOMapping(b,A);const P=e.render.frame;s[b.id]!==P&&(d(b),s[b.id]=P)}function u(b){const _=h();b.__bindingPointIndex=_;const T=i.createBuffer(),A=b.__size,P=b.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,A,P),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,_,T),T}function h(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const _=r[b.id],T=b.uniforms,A=b.__cache;i.bindBuffer(i.UNIFORM_BUFFER,_);for(let P=0,L=T.length;P<L;P++){const y=T[P];if(p(y,P,A)===!0){const x=y.__offset,E=Array.isArray(y.value)?y.value:[y.value];let z=0;for(let $=0;$<E.length;$++){const I=E[$],N=v(I);typeof I=="number"?(y.__data[0]=I,i.bufferSubData(i.UNIFORM_BUFFER,x+z,y.__data)):I.isMatrix3?(y.__data[0]=I.elements[0],y.__data[1]=I.elements[1],y.__data[2]=I.elements[2],y.__data[3]=I.elements[0],y.__data[4]=I.elements[3],y.__data[5]=I.elements[4],y.__data[6]=I.elements[5],y.__data[7]=I.elements[0],y.__data[8]=I.elements[6],y.__data[9]=I.elements[7],y.__data[10]=I.elements[8],y.__data[11]=I.elements[0]):(I.toArray(y.__data,z),z+=N.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,x,y.__data)}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(b,_,T){const A=b.value;if(T[_]===void 0){if(typeof A=="number")T[_]=A;else{const P=Array.isArray(A)?A:[A],L=[];for(let y=0;y<P.length;y++)L.push(P[y].clone());T[_]=L}return!0}else if(typeof A=="number"){if(T[_]!==A)return T[_]=A,!0}else{const P=Array.isArray(T[_])?T[_]:[T[_]],L=Array.isArray(A)?A:[A];for(let y=0;y<P.length;y++){const x=P[y];if(x.equals(L[y])===!1)return x.copy(L[y]),!0}}return!1}function g(b){const _=b.uniforms;let T=0;const A=16;let P=0;for(let L=0,y=_.length;L<y;L++){const x=_[L],E={boundary:0,storage:0},z=Array.isArray(x.value)?x.value:[x.value];for(let $=0,I=z.length;$<I;$++){const N=z[$],F=v(N);E.boundary+=F.boundary,E.storage+=F.storage}if(x.__data=new Float32Array(E.storage/Float32Array.BYTES_PER_ELEMENT),x.__offset=T,L>0){P=T%A;const $=A-P;P!==0&&$-E.boundary<0&&(T+=A-P,x.__offset=T)}T+=E.storage}return P=T%A,P>0&&(T+=A-P),b.__size=T,b.__cache={},this}function v(b){const _={boundary:0,storage:0};return typeof b=="number"?(_.boundary=4,_.storage=4):b.isVector2?(_.boundary=8,_.storage=8):b.isVector3||b.isColor?(_.boundary=16,_.storage=12):b.isVector4?(_.boundary=16,_.storage=16):b.isMatrix3?(_.boundary=48,_.storage=48):b.isMatrix4?(_.boundary=64,_.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),_}function m(b){const _=b.target;_.removeEventListener("dispose",m);const T=a.indexOf(_.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function f(){for(const b in r)i.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:f}}function mx(){const i=nr("canvas");return i.style.display="block",i}class Ic{constructor(e={}){const{canvas:t=mx(),context:n=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let d;n!==null?d=n.getContextAttributes().alpha:d=a;const p=new Uint32Array(4),g=new Int32Array(4);let v=null,m=null;const f=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputColorSpace=ke,this.useLegacyLights=!0,this.toneMapping=yn,this.toneMappingExposure=1;const _=this;let T=!1,A=0,P=0,L=null,y=-1,x=null;const E=new bt,z=new bt;let $=null;const I=new et(0);let N=0,F=t.width,W=t.height,G=1,q=null,Z=null;const Q=new bt(0,0,F,W),de=new bt(0,0,F,W);let k=!1;const te=new wc;let ne=!1,fe=!1,ve=null;const Me=new Et,Ie=new ce,Le=new U,Ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Pe(){return L===null?G:1}let C=n;function ae(S,B){for(let Y=0;Y<S.length;Y++){const O=S[Y],j=t.getContext(O,B);if(j!==null)return j}return null}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${vo}`),t.addEventListener("webglcontextlost",pe,!1),t.addEventListener("webglcontextrestored",V,!1),t.addEventListener("webglcontextcreationerror",ue,!1),C===null){const B=["webgl2","webgl","experimental-webgl"];if(_.isWebGL1Renderer===!0&&B.shift(),C=ae(B,S),C===null)throw ae(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}C instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),C.getShaderPrecisionFormat===void 0&&(C.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let K,se,J,Ae,ge,xe,Ue,We,st,w,M,X,oe,re,R,ee,ie,H,Ee,Re,we,be,Se,Ne;function qe(){K=new Av(C),se=new xv(C,K,e),K.init(se),be=new lx(C,K,se),J=new ox(C,K,se),Ae=new Cv(C),ge=new q0,xe=new ax(C,K,J,ge,se,be,Ae),Ue=new Sv(_),We=new Tv(_),st=new km(C,se),Se=new _v(C,K,st,se),w=new wv(C,st,Ae,Se),M=new Iv(C,w,st,Ae),Ee=new Dv(C,se,xe),ee=new Mv(ge),X=new X0(_,Ue,We,K,se,Se,ee),oe=new fx(_,ge),re=new Y0,R=new ex(K,se),H=new gv(_,Ue,We,J,M,d,l),ie=new sx(_,M,se),Ne=new px(C,Ae,se,J),Re=new vv(C,K,Ae,se),we=new Rv(C,K,Ae,se),Ae.programs=X.programs,_.capabilities=se,_.extensions=K,_.properties=ge,_.renderLists=re,_.shadowMap=ie,_.state=J,_.info=Ae}qe();const D=new dx(_,C);this.xr=D,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const S=K.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=K.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(S){S!==void 0&&(G=S,this.setSize(F,W,!1))},this.getSize=function(S){return S.set(F,W)},this.setSize=function(S,B,Y=!0){if(D.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}F=S,W=B,t.width=Math.floor(S*G),t.height=Math.floor(B*G),Y===!0&&(t.style.width=S+"px",t.style.height=B+"px"),this.setViewport(0,0,S,B)},this.getDrawingBufferSize=function(S){return S.set(F*G,W*G).floor()},this.setDrawingBufferSize=function(S,B,Y){F=S,W=B,G=Y,t.width=Math.floor(S*Y),t.height=Math.floor(B*Y),this.setViewport(0,0,S,B)},this.getCurrentViewport=function(S){return S.copy(E)},this.getViewport=function(S){return S.copy(Q)},this.setViewport=function(S,B,Y,O){S.isVector4?Q.set(S.x,S.y,S.z,S.w):Q.set(S,B,Y,O),J.viewport(E.copy(Q).multiplyScalar(G).floor())},this.getScissor=function(S){return S.copy(de)},this.setScissor=function(S,B,Y,O){S.isVector4?de.set(S.x,S.y,S.z,S.w):de.set(S,B,Y,O),J.scissor(z.copy(de).multiplyScalar(G).floor())},this.getScissorTest=function(){return k},this.setScissorTest=function(S){J.setScissorTest(k=S)},this.setOpaqueSort=function(S){q=S},this.setTransparentSort=function(S){Z=S},this.getClearColor=function(S){return S.copy(H.getClearColor())},this.setClearColor=function(){H.setClearColor.apply(H,arguments)},this.getClearAlpha=function(){return H.getClearAlpha()},this.setClearAlpha=function(){H.setClearAlpha.apply(H,arguments)},this.clear=function(S=!0,B=!0,Y=!0){let O=0;if(S){let j=!1;if(L!==null){const ye=L.texture.format;j=ye===hc||ye===uc||ye===cc}if(j){const ye=L.texture.type,De=ye===Nn||ye===Dn||ye===xo||ye===Zn||ye===ac||ye===lc,Oe=H.getClearColor(),Fe=H.getClearAlpha(),Xe=Oe.r,Be=Oe.g,ze=Oe.b,it=ge.get(L).__webglFramebuffer;De?(p[0]=Xe,p[1]=Be,p[2]=ze,p[3]=Fe,C.clearBufferuiv(C.COLOR,it,p)):(g[0]=Xe,g[1]=Be,g[2]=ze,g[3]=Fe,C.clearBufferiv(C.COLOR,it,g))}else O|=C.COLOR_BUFFER_BIT}B&&(O|=C.DEPTH_BUFFER_BIT),Y&&(O|=C.STENCIL_BUFFER_BIT),C.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",pe,!1),t.removeEventListener("webglcontextrestored",V,!1),t.removeEventListener("webglcontextcreationerror",ue,!1),re.dispose(),R.dispose(),ge.dispose(),Ue.dispose(),We.dispose(),M.dispose(),Se.dispose(),Ne.dispose(),X.dispose(),D.dispose(),D.removeEventListener("sessionstart",ct),D.removeEventListener("sessionend",tn),ve&&(ve.dispose(),ve=null),Rt.stop()};function pe(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function V(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const S=Ae.autoReset,B=ie.enabled,Y=ie.autoUpdate,O=ie.needsUpdate,j=ie.type;qe(),Ae.autoReset=S,ie.enabled=B,ie.autoUpdate=Y,ie.needsUpdate=O,ie.type=j}function ue(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function _e(S){const B=S.target;B.removeEventListener("dispose",_e),Ze(B)}function Ze(S){lt(S),ge.remove(S)}function lt(S){const B=ge.get(S).programs;B!==void 0&&(B.forEach(function(Y){X.releaseProgram(Y)}),S.isShaderMaterial&&X.releaseShaderCache(S))}this.renderBufferDirect=function(S,B,Y,O,j,ye){B===null&&(B=Ye);const De=j.isMesh&&j.matrixWorld.determinant()<0,Oe=Gc(S,B,Y,O,j);J.setMaterial(O,De);let Fe=Y.index,Xe=1;O.wireframe===!0&&(Fe=w.getWireframeAttribute(Y),Xe=2);const Be=Y.drawRange,ze=Y.attributes.position;let it=Be.start*Xe,ut=(Be.start+Be.count)*Xe;ye!==null&&(it=Math.max(it,ye.start*Xe),ut=Math.min(ut,(ye.start+ye.count)*Xe)),Fe!==null?(it=Math.max(it,0),ut=Math.min(ut,Fe.count)):ze!=null&&(it=Math.max(it,0),ut=Math.min(ut,ze.count));const Xt=ut-it;if(Xt<0||Xt===1/0)return;Se.setup(j,O,Oe,Y,Fe);let ln,ft=Re;if(Fe!==null&&(ln=st.get(Fe),ft=we,ft.setIndex(ln)),j.isMesh)O.wireframe===!0?(J.setLineWidth(O.wireframeLinewidth*Pe()),ft.setMode(C.LINES)):ft.setMode(C.TRIANGLES);else if(j.isLine){let $e=O.linewidth;$e===void 0&&($e=1),J.setLineWidth($e*Pe()),j.isLineSegments?ft.setMode(C.LINES):j.isLineLoop?ft.setMode(C.LINE_LOOP):ft.setMode(C.LINE_STRIP)}else j.isPoints?ft.setMode(C.POINTS):j.isSprite&&ft.setMode(C.TRIANGLES);if(j.isInstancedMesh)ft.renderInstances(it,Xt,j.count);else if(Y.isInstancedBufferGeometry){const $e=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,rs=Math.min(Y.instanceCount,$e);ft.renderInstances(it,Xt,rs)}else ft.render(it,Xt)},this.compile=function(S,B){function Y(O,j,ye){O.transparent===!0&&O.side===rn&&O.forceSinglePass===!1?(O.side=It,O.needsUpdate=!0,dr(O,j,ye),O.side=Fn,O.needsUpdate=!0,dr(O,j,ye),O.side=rn):dr(O,j,ye)}m=R.get(S),m.init(),b.push(m),S.traverseVisible(function(O){O.isLight&&O.layers.test(B.layers)&&(m.pushLight(O),O.castShadow&&m.pushShadow(O))}),m.setupLights(_.useLegacyLights),S.traverse(function(O){const j=O.material;if(j)if(Array.isArray(j))for(let ye=0;ye<j.length;ye++){const De=j[ye];Y(De,S,O)}else Y(j,S,O)}),b.pop(),m=null};let dt=null;function zn(S){dt&&dt(S)}function ct(){Rt.stop()}function tn(){Rt.start()}const Rt=new Rc;Rt.setAnimationLoop(zn),typeof self<"u"&&Rt.setContext(self),this.setAnimationLoop=function(S){dt=S,D.setAnimationLoop(S),S===null?Rt.stop():Rt.start()},D.addEventListener("sessionstart",ct),D.addEventListener("sessionend",tn),this.render=function(S,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),D.enabled===!0&&D.isPresenting===!0&&(B=D.updateCameraXR(B)),S.isScene===!0&&S.onBeforeRender(_,S,B,L),m=R.get(S,b.length),m.init(),b.push(m),Me.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),te.setFromProjectionMatrix(Me),fe=this.localClippingEnabled,ne=ee.init(this.clippingPlanes,fe),v=re.get(S,f.length),v.init(),f.push(v),wo(S,B,0,_.sortObjects),v.finish(),_.sortObjects===!0&&v.sort(q,Z),ne===!0&&ee.beginShadows();const Y=m.state.shadowsArray;if(ie.render(Y,S,B),ne===!0&&ee.endShadows(),this.info.autoReset===!0&&this.info.reset(),this.info.render.frame++,H.render(v,S),m.setupLights(_.useLegacyLights),B.isArrayCamera){const O=B.cameras;for(let j=0,ye=O.length;j<ye;j++){const De=O[j];Ro(v,S,De,De.viewport)}}else Ro(v,S,B);L!==null&&(xe.updateMultisampleRenderTarget(L),xe.updateRenderTargetMipmap(L)),S.isScene===!0&&S.onAfterRender(_,S,B),Se.resetDefaultState(),y=-1,x=null,b.pop(),b.length>0?m=b[b.length-1]:m=null,f.pop(),f.length>0?v=f[f.length-1]:v=null};function wo(S,B,Y,O){if(S.visible===!1)return;if(S.layers.test(B.layers)){if(S.isGroup)Y=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(B);else if(S.isLight)m.pushLight(S),S.castShadow&&m.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||te.intersectsSprite(S)){O&&Le.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Me);const De=M.update(S),Oe=S.material;Oe.visible&&v.push(S,De,Oe,Y,Le.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||te.intersectsObject(S))){S.isSkinnedMesh&&S.skeleton.frame!==Ae.render.frame&&(S.skeleton.update(),S.skeleton.frame=Ae.render.frame);const De=M.update(S),Oe=S.material;if(O&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Le.copy(S.boundingSphere.center)):(De.boundingSphere===null&&De.computeBoundingSphere(),Le.copy(De.boundingSphere.center)),Le.applyMatrix4(S.matrixWorld).applyMatrix4(Me)),Array.isArray(Oe)){const Fe=De.groups;for(let Xe=0,Be=Fe.length;Xe<Be;Xe++){const ze=Fe[Xe],it=Oe[ze.materialIndex];it&&it.visible&&v.push(S,De,it,Y,Le.z,ze)}}else Oe.visible&&v.push(S,De,Oe,Y,Le.z,null)}}const ye=S.children;for(let De=0,Oe=ye.length;De<Oe;De++)wo(ye[De],B,Y,O)}function Ro(S,B,Y,O){const j=S.opaque,ye=S.transmissive,De=S.transparent;m.setupLightsView(Y),ne===!0&&ee.setGlobalState(_.clippingPlanes,Y),ye.length>0&&Hc(j,ye,B,Y),O&&J.viewport(E.copy(O)),j.length>0&&hr(j,B,Y),ye.length>0&&hr(ye,B,Y),De.length>0&&hr(De,B,Y),J.buffers.depth.setTest(!0),J.buffers.depth.setMask(!0),J.buffers.color.setMask(!0),J.setPolygonOffset(!1)}function Hc(S,B,Y,O){const j=se.isWebGL2;ve===null&&(ve=new ti(1,1,{generateMipmaps:!0,type:K.has("EXT_color_buffer_half_float")?tr:Nn,minFilter:er,samples:j&&o===!0?4:0})),_.getDrawingBufferSize(Ie),j?ve.setSize(Ie.x,Ie.y):ve.setSize(Js(Ie.x),Js(Ie.y));const ye=_.getRenderTarget();_.setRenderTarget(ve),_.getClearColor(I),N=_.getClearAlpha(),N<1&&_.setClearColor(16777215,.5),_.clear();const De=_.toneMapping;_.toneMapping=yn,hr(S,Y,O),xe.updateMultisampleRenderTarget(ve),xe.updateRenderTargetMipmap(ve);let Oe=!1;for(let Fe=0,Xe=B.length;Fe<Xe;Fe++){const Be=B[Fe],ze=Be.object,it=Be.geometry,ut=Be.material,Xt=Be.group;if(ut.side===rn&&ze.layers.test(O.layers)){const ln=ut.side;ut.side=It,ut.needsUpdate=!0,Co(ze,Y,O,it,ut,Xt),ut.side=ln,ut.needsUpdate=!0,Oe=!0}}Oe===!0&&(xe.updateMultisampleRenderTarget(ve),xe.updateRenderTargetMipmap(ve)),_.setRenderTarget(ye),_.setClearColor(I,N),_.toneMapping=De}function hr(S,B,Y){const O=B.isScene===!0?B.overrideMaterial:null;for(let j=0,ye=S.length;j<ye;j++){const De=S[j],Oe=De.object,Fe=De.geometry,Xe=O===null?De.material:O,Be=De.group;Oe.layers.test(Y.layers)&&Co(Oe,B,Y,Fe,Xe,Be)}}function Co(S,B,Y,O,j,ye){S.onBeforeRender(_,B,Y,O,j,ye),S.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),j.onBeforeRender(_,B,Y,O,S,ye),j.transparent===!0&&j.side===rn&&j.forceSinglePass===!1?(j.side=It,j.needsUpdate=!0,_.renderBufferDirect(Y,B,O,j,S,ye),j.side=Fn,j.needsUpdate=!0,_.renderBufferDirect(Y,B,O,j,S,ye),j.side=rn):_.renderBufferDirect(Y,B,O,j,S,ye),S.onAfterRender(_,B,Y,O,j,ye)}function dr(S,B,Y){B.isScene!==!0&&(B=Ye);const O=ge.get(S),j=m.state.lights,ye=m.state.shadowsArray,De=j.state.version,Oe=X.getParameters(S,j.state,ye,B,Y),Fe=X.getProgramCacheKey(Oe);let Xe=O.programs;O.environment=S.isMeshStandardMaterial?B.environment:null,O.fog=B.fog,O.envMap=(S.isMeshStandardMaterial?We:Ue).get(S.envMap||O.environment),Xe===void 0&&(S.addEventListener("dispose",_e),Xe=new Map,O.programs=Xe);let Be=Xe.get(Fe);if(Be!==void 0){if(O.currentProgram===Be&&O.lightsStateVersion===De)return Lo(S,Oe),Be}else Oe.uniforms=X.getUniforms(S),S.onBuild(Y,Oe,_),S.onBeforeCompile(Oe,_),Be=X.acquireProgram(Oe,Fe),Xe.set(Fe,Be),O.uniforms=Oe.uniforms;const ze=O.uniforms;(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ze.clippingPlanes=ee.uniform),Lo(S,Oe),O.needsLights=Wc(S),O.lightsStateVersion=De,O.needsLights&&(ze.ambientLightColor.value=j.state.ambient,ze.lightProbe.value=j.state.probe,ze.directionalLights.value=j.state.directional,ze.directionalLightShadows.value=j.state.directionalShadow,ze.spotLights.value=j.state.spot,ze.spotLightShadows.value=j.state.spotShadow,ze.rectAreaLights.value=j.state.rectArea,ze.ltc_1.value=j.state.rectAreaLTC1,ze.ltc_2.value=j.state.rectAreaLTC2,ze.pointLights.value=j.state.point,ze.pointLightShadows.value=j.state.pointShadow,ze.hemisphereLights.value=j.state.hemi,ze.directionalShadowMap.value=j.state.directionalShadowMap,ze.directionalShadowMatrix.value=j.state.directionalShadowMatrix,ze.spotShadowMap.value=j.state.spotShadowMap,ze.spotLightMatrix.value=j.state.spotLightMatrix,ze.spotLightMap.value=j.state.spotLightMap,ze.pointShadowMap.value=j.state.pointShadowMap,ze.pointShadowMatrix.value=j.state.pointShadowMatrix);const it=Be.getUniforms(),ut=Gr.seqWithValue(it.seq,ze);return O.currentProgram=Be,O.uniformsList=ut,Be}function Lo(S,B){const Y=ge.get(S);Y.outputColorSpace=B.outputColorSpace,Y.instancing=B.instancing,Y.skinning=B.skinning,Y.morphTargets=B.morphTargets,Y.morphNormals=B.morphNormals,Y.morphColors=B.morphColors,Y.morphTargetsCount=B.morphTargetsCount,Y.numClippingPlanes=B.numClippingPlanes,Y.numIntersection=B.numClipIntersection,Y.vertexAlphas=B.vertexAlphas,Y.vertexTangents=B.vertexTangents,Y.toneMapping=B.toneMapping}function Gc(S,B,Y,O,j){B.isScene!==!0&&(B=Ye),xe.resetTextureUnits();const ye=B.fog,De=O.isMeshStandardMaterial?B.environment:null,Oe=L===null?_.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:on,Fe=(O.isMeshStandardMaterial?We:Ue).get(O.envMap||De),Xe=O.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,Be=!!Y.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),ze=!!Y.morphAttributes.position,it=!!Y.morphAttributes.normal,ut=!!Y.morphAttributes.color,Xt=O.toneMapped?_.toneMapping:yn,ln=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,ft=ln!==void 0?ln.length:0,$e=ge.get(O),rs=m.state.lights;if(ne===!0&&(fe===!0||S!==x)){const Nt=S===x&&O.id===y;ee.setState(O,S,Nt)}let xt=!1;O.version===$e.__version?($e.needsLights&&$e.lightsStateVersion!==rs.state.version||$e.outputColorSpace!==Oe||j.isInstancedMesh&&$e.instancing===!1||!j.isInstancedMesh&&$e.instancing===!0||j.isSkinnedMesh&&$e.skinning===!1||!j.isSkinnedMesh&&$e.skinning===!0||$e.envMap!==Fe||O.fog===!0&&$e.fog!==ye||$e.numClippingPlanes!==void 0&&($e.numClippingPlanes!==ee.numPlanes||$e.numIntersection!==ee.numIntersection)||$e.vertexAlphas!==Xe||$e.vertexTangents!==Be||$e.morphTargets!==ze||$e.morphNormals!==it||$e.morphColors!==ut||$e.toneMapping!==Xt||se.isWebGL2===!0&&$e.morphTargetsCount!==ft)&&(xt=!0):(xt=!0,$e.__version=O.version);let kn=$e.currentProgram;xt===!0&&(kn=dr(O,B,j));let Po=!1,Gi=!1,ss=!1;const Ct=kn.getUniforms(),Hn=$e.uniforms;if(J.useProgram(kn.program)&&(Po=!0,Gi=!0,ss=!0),O.id!==y&&(y=O.id,Gi=!0),Po||x!==S){if(Ct.setValue(C,"projectionMatrix",S.projectionMatrix),se.logarithmicDepthBuffer&&Ct.setValue(C,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),x!==S&&(x=S,Gi=!0,ss=!0),O.isShaderMaterial||O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshStandardMaterial||O.envMap){const Nt=Ct.map.cameraPosition;Nt!==void 0&&Nt.setValue(C,Le.setFromMatrixPosition(S.matrixWorld))}(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&Ct.setValue(C,"isOrthographic",S.isOrthographicCamera===!0),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial||O.isShadowMaterial||j.isSkinnedMesh)&&Ct.setValue(C,"viewMatrix",S.matrixWorldInverse)}if(j.isSkinnedMesh){Ct.setOptional(C,j,"bindMatrix"),Ct.setOptional(C,j,"bindMatrixInverse");const Nt=j.skeleton;Nt&&(se.floatVertexTextures?(Nt.boneTexture===null&&Nt.computeBoneTexture(),Ct.setValue(C,"boneTexture",Nt.boneTexture,xe),Ct.setValue(C,"boneTextureSize",Nt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const os=Y.morphAttributes;if((os.position!==void 0||os.normal!==void 0||os.color!==void 0&&se.isWebGL2===!0)&&Ee.update(j,Y,kn),(Gi||$e.receiveShadow!==j.receiveShadow)&&($e.receiveShadow=j.receiveShadow,Ct.setValue(C,"receiveShadow",j.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(Hn.envMap.value=Fe,Hn.flipEnvMap.value=Fe.isCubeTexture&&Fe.isRenderTargetTexture===!1?-1:1),Gi&&(Ct.setValue(C,"toneMappingExposure",_.toneMappingExposure),$e.needsLights&&Vc(Hn,ss),ye&&O.fog===!0&&oe.refreshFogUniforms(Hn,ye),oe.refreshMaterialUniforms(Hn,O,G,W,ve),Gr.upload(C,$e.uniformsList,Hn,xe)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(Gr.upload(C,$e.uniformsList,Hn,xe),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&Ct.setValue(C,"center",j.center),Ct.setValue(C,"modelViewMatrix",j.modelViewMatrix),Ct.setValue(C,"normalMatrix",j.normalMatrix),Ct.setValue(C,"modelMatrix",j.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const Nt=O.uniformsGroups;for(let as=0,Xc=Nt.length;as<Xc;as++)if(se.isWebGL2){const Do=Nt[as];Ne.update(Do,kn),Ne.bind(Do,kn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return kn}function Vc(S,B){S.ambientLightColor.needsUpdate=B,S.lightProbe.needsUpdate=B,S.directionalLights.needsUpdate=B,S.directionalLightShadows.needsUpdate=B,S.pointLights.needsUpdate=B,S.pointLightShadows.needsUpdate=B,S.spotLights.needsUpdate=B,S.spotLightShadows.needsUpdate=B,S.rectAreaLights.needsUpdate=B,S.hemisphereLights.needsUpdate=B}function Wc(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(S,B,Y){ge.get(S.texture).__webglTexture=B,ge.get(S.depthTexture).__webglTexture=Y;const O=ge.get(S);O.__hasExternalTextures=!0,O.__hasExternalTextures&&(O.__autoAllocateDepthBuffer=Y===void 0,O.__autoAllocateDepthBuffer||K.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),O.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(S,B){const Y=ge.get(S);Y.__webglFramebuffer=B,Y.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(S,B=0,Y=0){L=S,A=B,P=Y;let O=!0,j=null,ye=!1,De=!1;if(S){const Fe=ge.get(S);Fe.__useDefaultFramebuffer!==void 0?(J.bindFramebuffer(C.FRAMEBUFFER,null),O=!1):Fe.__webglFramebuffer===void 0?xe.setupRenderTarget(S):Fe.__hasExternalTextures&&xe.rebindTextures(S,ge.get(S.texture).__webglTexture,ge.get(S.depthTexture).__webglTexture);const Xe=S.texture;(Xe.isData3DTexture||Xe.isDataArrayTexture||Xe.isCompressedArrayTexture)&&(De=!0);const Be=ge.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(j=Be[B],ye=!0):se.isWebGL2&&S.samples>0&&xe.useMultisampledRTT(S)===!1?j=ge.get(S).__webglMultisampledFramebuffer:j=Be,E.copy(S.viewport),z.copy(S.scissor),$=S.scissorTest}else E.copy(Q).multiplyScalar(G).floor(),z.copy(de).multiplyScalar(G).floor(),$=k;if(J.bindFramebuffer(C.FRAMEBUFFER,j)&&se.drawBuffers&&O&&J.drawBuffers(S,j),J.viewport(E),J.scissor(z),J.setScissorTest($),ye){const Fe=ge.get(S.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+B,Fe.__webglTexture,Y)}else if(De){const Fe=ge.get(S.texture),Xe=B||0;C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,Fe.__webglTexture,Y||0,Xe)}y=-1},this.readRenderTargetPixels=function(S,B,Y,O,j,ye,De){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Oe=ge.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&De!==void 0&&(Oe=Oe[De]),Oe){J.bindFramebuffer(C.FRAMEBUFFER,Oe);try{const Fe=S.texture,Xe=Fe.format,Be=Fe.type;if(Xe!==Jt&&be.convert(Xe)!==C.getParameter(C.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ze=Be===tr&&(K.has("EXT_color_buffer_half_float")||se.isWebGL2&&K.has("EXT_color_buffer_float"));if(Be!==Nn&&be.convert(Be)!==C.getParameter(C.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Be===In&&(se.isWebGL2||K.has("OES_texture_float")||K.has("WEBGL_color_buffer_float")))&&!ze){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=S.width-O&&Y>=0&&Y<=S.height-j&&C.readPixels(B,Y,O,j,be.convert(Xe),be.convert(Be),ye)}finally{const Fe=L!==null?ge.get(L).__webglFramebuffer:null;J.bindFramebuffer(C.FRAMEBUFFER,Fe)}}},this.copyFramebufferToTexture=function(S,B,Y=0){const O=Math.pow(2,-Y),j=Math.floor(B.image.width*O),ye=Math.floor(B.image.height*O);xe.setTexture2D(B,0),C.copyTexSubImage2D(C.TEXTURE_2D,Y,0,0,S.x,S.y,j,ye),J.unbindTexture()},this.copyTextureToTexture=function(S,B,Y,O=0){const j=B.image.width,ye=B.image.height,De=be.convert(Y.format),Oe=be.convert(Y.type);xe.setTexture2D(Y,0),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,Y.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,Y.unpackAlignment),B.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,O,S.x,S.y,j,ye,De,Oe,B.image.data):B.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,O,S.x,S.y,B.mipmaps[0].width,B.mipmaps[0].height,De,B.mipmaps[0].data):C.texSubImage2D(C.TEXTURE_2D,O,S.x,S.y,De,Oe,B.image),O===0&&Y.generateMipmaps&&C.generateMipmap(C.TEXTURE_2D),J.unbindTexture()},this.copyTextureToTexture3D=function(S,B,Y,O,j=0){if(_.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const ye=S.max.x-S.min.x+1,De=S.max.y-S.min.y+1,Oe=S.max.z-S.min.z+1,Fe=be.convert(O.format),Xe=be.convert(O.type);let Be;if(O.isData3DTexture)xe.setTexture3D(O,0),Be=C.TEXTURE_3D;else if(O.isDataArrayTexture)xe.setTexture2DArray(O,0),Be=C.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,O.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,O.unpackAlignment);const ze=C.getParameter(C.UNPACK_ROW_LENGTH),it=C.getParameter(C.UNPACK_IMAGE_HEIGHT),ut=C.getParameter(C.UNPACK_SKIP_PIXELS),Xt=C.getParameter(C.UNPACK_SKIP_ROWS),ln=C.getParameter(C.UNPACK_SKIP_IMAGES),ft=Y.isCompressedTexture?Y.mipmaps[0]:Y.image;C.pixelStorei(C.UNPACK_ROW_LENGTH,ft.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ft.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,S.min.x),C.pixelStorei(C.UNPACK_SKIP_ROWS,S.min.y),C.pixelStorei(C.UNPACK_SKIP_IMAGES,S.min.z),Y.isDataTexture||Y.isData3DTexture?C.texSubImage3D(Be,j,B.x,B.y,B.z,ye,De,Oe,Fe,Xe,ft.data):Y.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),C.compressedTexSubImage3D(Be,j,B.x,B.y,B.z,ye,De,Oe,Fe,ft.data)):C.texSubImage3D(Be,j,B.x,B.y,B.z,ye,De,Oe,Fe,Xe,ft),C.pixelStorei(C.UNPACK_ROW_LENGTH,ze),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,it),C.pixelStorei(C.UNPACK_SKIP_PIXELS,ut),C.pixelStorei(C.UNPACK_SKIP_ROWS,Xt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,ln),j===0&&O.generateMipmaps&&C.generateMipmap(Be),J.unbindTexture()},this.initTexture=function(S){S.isCubeTexture?xe.setTextureCube(S,0):S.isData3DTexture?xe.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?xe.setTexture2DArray(S,0):xe.setTexture2D(S,0),J.unbindTexture()},this.resetState=function(){A=0,P=0,L=null,J.reset(),Se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return vn}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===ke?Qn:dc}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Qn?ke:on}}class gx extends Ic{}gx.prototype.isWebGL1Renderer=!0;class _x extends zt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}get autoUpdate(){return console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate}set autoUpdate(e){console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate=e}}class an{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const n=this.getUtoTmapping(e);return this.getPoint(n,t)}getPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return t}getSpacedPoints(e=5){const t=[];for(let n=0;n<=e;n++)t.push(this.getPointAt(n/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let n,r=this.getPoint(0),s=0;t.push(0);for(let a=1;a<=e;a++)n=this.getPoint(a/e),s+=n.distanceTo(r),t.push(s),r=n;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const n=this.getLengths();let r=0;const s=n.length;let a;t?a=t:a=e*n[s-1];let o=0,l=s-1,c;for(;o<=l;)if(r=Math.floor(o+(l-o)/2),c=n[r]-a,c<0)o=r+1;else if(c>0)l=r-1;else{l=r;break}if(r=l,n[r]===a)return r/(s-1);const u=n[r],d=n[r+1]-u,p=(a-u)/d;return(r+p)/(s-1)}getTangent(e,t){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const a=this.getPoint(r),o=this.getPoint(s),l=t||(a.isVector2?new ce:new U);return l.copy(o).sub(a).normalize(),l}getTangentAt(e,t){const n=this.getUtoTmapping(e);return this.getTangent(n,t)}computeFrenetFrames(e,t){const n=new U,r=[],s=[],a=[],o=new U,l=new Et;for(let p=0;p<=e;p++){const g=p/e;r[p]=this.getTangentAt(g,new U)}s[0]=new U,a[0]=new U;let c=Number.MAX_VALUE;const u=Math.abs(r[0].x),h=Math.abs(r[0].y),d=Math.abs(r[0].z);u<=c&&(c=u,n.set(1,0,0)),h<=c&&(c=h,n.set(0,1,0)),d<=c&&n.set(0,0,1),o.crossVectors(r[0],n).normalize(),s[0].crossVectors(r[0],o),a[0].crossVectors(r[0],s[0]);for(let p=1;p<=e;p++){if(s[p]=s[p-1].clone(),a[p]=a[p-1].clone(),o.crossVectors(r[p-1],r[p]),o.length()>Number.EPSILON){o.normalize();const g=Math.acos(St(r[p-1].dot(r[p]),-1,1));s[p].applyMatrix4(l.makeRotationAxis(o,g))}a[p].crossVectors(r[p],s[p])}if(t===!0){let p=Math.acos(St(s[0].dot(s[e]),-1,1));p/=e,r[0].dot(o.crossVectors(s[0],s[e]))>0&&(p=-p);for(let g=1;g<=e;g++)s[g].applyMatrix4(l.makeRotationAxis(r[g],p*g)),a[g].crossVectors(r[g],s[g])}return{tangents:r,normals:s,binormals:a}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class Eo extends an{constructor(e=0,t=0,n=1,r=1,s=0,a=Math.PI*2,o=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=n,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=a,this.aClockwise=o,this.aRotation=l}getPoint(e,t){const n=t||new ce,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const a=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(a?s=0:s=r),this.aClockwise===!0&&!a&&(s===r?s=-r:s=s-r);const o=this.aStartAngle+e*s;let l=this.aX+this.xRadius*Math.cos(o),c=this.aY+this.yRadius*Math.sin(o);if(this.aRotation!==0){const u=Math.cos(this.aRotation),h=Math.sin(this.aRotation),d=l-this.aX,p=c-this.aY;l=d*u-p*h+this.aX,c=d*h+p*u+this.aY}return n.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class vx extends Eo{constructor(e,t,n,r,s,a){super(e,t,n,n,r,s,a),this.isArcCurve=!0,this.type="ArcCurve"}}function bo(){let i=0,e=0,t=0,n=0;function r(s,a,o,l){i=s,e=o,t=-3*s+3*a-2*o-l,n=2*s-2*a+o+l}return{initCatmullRom:function(s,a,o,l,c){r(a,o,c*(o-s),c*(l-a))},initNonuniformCatmullRom:function(s,a,o,l,c,u,h){let d=(a-s)/c-(o-s)/(c+u)+(o-a)/u,p=(o-a)/u-(l-a)/(u+h)+(l-o)/h;d*=u,p*=u,r(a,o,d,p)},calc:function(s){const a=s*s,o=a*s;return i+e*s+t*a+n*o}}}const Fr=new U,ks=new bo,Hs=new bo,Gs=new bo;class xx extends an{constructor(e=[],t=!1,n="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=n,this.tension=r}getPoint(e,t=new U){const n=t,r=this.points,s=r.length,a=(s-(this.closed?0:1))*e;let o=Math.floor(a),l=a-o;this.closed?o+=o>0?0:(Math.floor(Math.abs(o)/s)+1)*s:l===0&&o===s-1&&(o=s-2,l=1);let c,u;this.closed||o>0?c=r[(o-1)%s]:(Fr.subVectors(r[0],r[1]).add(r[0]),c=Fr);const h=r[o%s],d=r[(o+1)%s];if(this.closed||o+2<s?u=r[(o+2)%s]:(Fr.subVectors(r[s-1],r[s-2]).add(r[s-1]),u=Fr),this.curveType==="centripetal"||this.curveType==="chordal"){const p=this.curveType==="chordal"?.5:.25;let g=Math.pow(c.distanceToSquared(h),p),v=Math.pow(h.distanceToSquared(d),p),m=Math.pow(d.distanceToSquared(u),p);v<1e-4&&(v=1),g<1e-4&&(g=v),m<1e-4&&(m=v),ks.initNonuniformCatmullRom(c.x,h.x,d.x,u.x,g,v,m),Hs.initNonuniformCatmullRom(c.y,h.y,d.y,u.y,g,v,m),Gs.initNonuniformCatmullRom(c.z,h.z,d.z,u.z,g,v,m)}else this.curveType==="catmullrom"&&(ks.initCatmullRom(c.x,h.x,d.x,u.x,this.tension),Hs.initCatmullRom(c.y,h.y,d.y,u.y,this.tension),Gs.initCatmullRom(c.z,h.z,d.z,u.z,this.tension));return n.set(ks.calc(l),Hs.calc(l),Gs.calc(l)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new U().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function vl(i,e,t,n,r){const s=(n-e)*.5,a=(r-t)*.5,o=i*i,l=i*o;return(2*t-2*n+s+a)*l+(-3*t+3*n-2*s-a)*o+s*i+t}function Mx(i,e){const t=1-i;return t*t*e}function Sx(i,e){return 2*(1-i)*i*e}function yx(i,e){return i*i*e}function Ki(i,e,t,n){return Mx(i,e)+Sx(i,t)+yx(i,n)}function Ex(i,e){const t=1-i;return t*t*t*e}function bx(i,e){const t=1-i;return 3*t*t*i*e}function Tx(i,e){return 3*(1-i)*i*i*e}function Ax(i,e){return i*i*i*e}function Zi(i,e,t,n,r){return Ex(i,e)+bx(i,t)+Tx(i,n)+Ax(i,r)}class Uc extends an{constructor(e=new ce,t=new ce,n=new ce,r=new ce){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new ce){const n=t,r=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Zi(e,r.x,s.x,a.x,o.x),Zi(e,r.y,s.y,a.y,o.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class wx extends an{constructor(e=new U,t=new U,n=new U,r=new U){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=n,this.v3=r}getPoint(e,t=new U){const n=t,r=this.v0,s=this.v1,a=this.v2,o=this.v3;return n.set(Zi(e,r.x,s.x,a.x,o.x),Zi(e,r.y,s.y,a.y,o.y),Zi(e,r.z,s.z,a.z,o.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class To extends an{constructor(e=new ce,t=new ce){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new ce){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new ce){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Rx extends an{constructor(e=new U,t=new U){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new U){const n=t;return e===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(e).add(this.v1)),n}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new U){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Nc extends an{constructor(e=new ce,t=new ce,n=new ce){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new ce){const n=t,r=this.v0,s=this.v1,a=this.v2;return n.set(Ki(e,r.x,s.x,a.x),Ki(e,r.y,s.y,a.y)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Cx extends an{constructor(e=new U,t=new U,n=new U){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=n}getPoint(e,t=new U){const n=t,r=this.v0,s=this.v1,a=this.v2;return n.set(Ki(e,r.x,s.x,a.x),Ki(e,r.y,s.y,a.y),Ki(e,r.z,s.z,a.z)),n}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Oc extends an{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new ce){const n=t,r=this.points,s=(r.length-1)*e,a=Math.floor(s),o=s-a,l=r[a===0?a:a-1],c=r[a],u=r[a>r.length-2?r.length-1:a+1],h=r[a>r.length-3?r.length-1:a+2];return n.set(vl(o,l.x,c.x,u.x,h.x),vl(o,l.y,c.y,u.y,h.y)),n}copy(e){super.copy(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,n=this.points.length;t<n;t++){const r=this.points[t];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,n=e.points.length;t<n;t++){const r=e.points[t];this.points.push(new ce().fromArray(r))}return this}}var Fc=Object.freeze({__proto__:null,ArcCurve:vx,CatmullRomCurve3:xx,CubicBezierCurve:Uc,CubicBezierCurve3:wx,EllipseCurve:Eo,LineCurve:To,LineCurve3:Rx,QuadraticBezierCurve:Nc,QuadraticBezierCurve3:Cx,SplineCurve:Oc});class Lx extends an{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);e.equals(t)||this.curves.push(new To(t,e))}getPoint(e,t){const n=e*this.getLength(),r=this.getCurveLengths();let s=0;for(;s<r.length;){if(r[s]>=n){const a=r[s]-n,o=this.curves[s],l=o.getLength(),c=l===0?0:1-a/l;return o.getPointAt(c,t)}s++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let n=0,r=this.curves.length;n<r;n++)t+=this.curves[n].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let n=0;n<=e;n++)t.push(this.getPoint(n/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let n;for(let r=0,s=this.curves;r<s.length;r++){const a=s[r],o=a.isEllipseCurve?e*2:a.isLineCurve||a.isLineCurve3?1:a.isSplineCurve?e*a.points.length:e,l=a.getPoints(o);for(let c=0;c<l.length;c++){const u=l[c];n&&n.equals(u)||(t.push(u),n=u)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(r.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,n=this.curves.length;t<n;t++){const r=this.curves[t];e.curves.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,n=e.curves.length;t<n;t++){const r=e.curves[t];this.curves.push(new Fc[r.type]().fromJSON(r))}return this}}class eo extends Lx{constructor(e){super(),this.type="Path",this.currentPoint=new ce,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,n=e.length;t<n;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const n=new To(this.currentPoint.clone(),new ce(e,t));return this.curves.push(n),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,n,r){const s=new Nc(this.currentPoint.clone(),new ce(e,t),new ce(n,r));return this.curves.push(s),this.currentPoint.set(n,r),this}bezierCurveTo(e,t,n,r,s,a){const o=new Uc(this.currentPoint.clone(),new ce(e,t),new ce(n,r),new ce(s,a));return this.curves.push(o),this.currentPoint.set(s,a),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),n=new Oc(t);return this.curves.push(n),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,n,r,s,a){const o=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+o,t+l,n,r,s,a),this}absarc(e,t,n,r,s,a){return this.absellipse(e,t,n,n,r,s,a),this}ellipse(e,t,n,r,s,a,o,l){const c=this.currentPoint.x,u=this.currentPoint.y;return this.absellipse(e+c,t+u,n,r,s,a,o,l),this}absellipse(e,t,n,r,s,a,o,l){const c=new Eo(e,t,n,r,s,a,o,l);if(this.curves.length>0){const h=c.getPoint(0);h.equals(this.currentPoint)||this.lineTo(h.x,h.y)}this.curves.push(c);const u=c.getPoint(1);return this.currentPoint.copy(u),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class Vr extends eo{constructor(e){super(e),this.uuid=ki(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let n=0,r=this.holes.length;n<r;n++)t[n]=this.holes[n].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,n=this.holes.length;t<n;t++){const r=this.holes[t];e.holes.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,n=e.holes.length;t<n;t++){const r=e.holes[t];this.holes.push(new eo().fromJSON(r))}return this}}const Px={triangulate:function(i,e,t=2){const n=e&&e.length,r=n?e[0]*t:i.length;let s=Bc(i,0,r,t,!0);const a=[];if(!s||s.next===s.prev)return a;let o,l,c,u,h,d,p;if(n&&(s=Ox(i,e,s,t)),i.length>80*t){o=c=i[0],l=u=i[1];for(let g=t;g<r;g+=t)h=i[g],d=i[g+1],h<o&&(o=h),d<l&&(l=d),h>c&&(c=h),d>u&&(u=d);p=Math.max(c-o,u-l),p=p!==0?32767/p:0}return ir(s,a,t,o,l,p,0),a}};function Bc(i,e,t,n,r){let s,a;if(r===$x(i,e,t,n)>0)for(s=e;s<t;s+=n)a=xl(s,i[s],i[s+1],a);else for(s=t-n;s>=e;s-=n)a=xl(s,i[s],i[s+1],a);return a&&ns(a,a.next)&&(sr(a),a=a.next),a}function ri(i,e){if(!i)return i;e||(e=i);let t=i,n;do if(n=!1,!t.steiner&&(ns(t,t.next)||at(t.prev,t,t.next)===0)){if(sr(t),t=e=t.prev,t===t.next)break;n=!0}else t=t.next;while(n||t!==e);return e}function ir(i,e,t,n,r,s,a){if(!i)return;!a&&s&&Hx(i,n,r,s);let o=i,l,c;for(;i.prev!==i.next;){if(l=i.prev,c=i.next,s?Ix(i,n,r,s):Dx(i)){e.push(l.i/t|0),e.push(i.i/t|0),e.push(c.i/t|0),sr(i),i=c.next,o=c.next;continue}if(i=c,i===o){a?a===1?(i=Ux(ri(i),e,t),ir(i,e,t,n,r,s,2)):a===2&&Nx(i,e,t,n,r,s):ir(ri(i),e,t,n,r,s,1);break}}}function Dx(i){const e=i.prev,t=i,n=i.next;if(at(e,t,n)>=0)return!1;const r=e.x,s=t.x,a=n.x,o=e.y,l=t.y,c=n.y,u=r<s?r<a?r:a:s<a?s:a,h=o<l?o<c?o:c:l<c?l:c,d=r>s?r>a?r:a:s>a?s:a,p=o>l?o>c?o:c:l>c?l:c;let g=n.next;for(;g!==e;){if(g.x>=u&&g.x<=d&&g.y>=h&&g.y<=p&&Pi(r,o,s,l,a,c,g.x,g.y)&&at(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function Ix(i,e,t,n){const r=i.prev,s=i,a=i.next;if(at(r,s,a)>=0)return!1;const o=r.x,l=s.x,c=a.x,u=r.y,h=s.y,d=a.y,p=o<l?o<c?o:c:l<c?l:c,g=u<h?u<d?u:d:h<d?h:d,v=o>l?o>c?o:c:l>c?l:c,m=u>h?u>d?u:d:h>d?h:d,f=to(p,g,e,t,n),b=to(v,m,e,t,n);let _=i.prevZ,T=i.nextZ;for(;_&&_.z>=f&&T&&T.z<=b;){if(_.x>=p&&_.x<=v&&_.y>=g&&_.y<=m&&_!==r&&_!==a&&Pi(o,u,l,h,c,d,_.x,_.y)&&at(_.prev,_,_.next)>=0||(_=_.prevZ,T.x>=p&&T.x<=v&&T.y>=g&&T.y<=m&&T!==r&&T!==a&&Pi(o,u,l,h,c,d,T.x,T.y)&&at(T.prev,T,T.next)>=0))return!1;T=T.nextZ}for(;_&&_.z>=f;){if(_.x>=p&&_.x<=v&&_.y>=g&&_.y<=m&&_!==r&&_!==a&&Pi(o,u,l,h,c,d,_.x,_.y)&&at(_.prev,_,_.next)>=0)return!1;_=_.prevZ}for(;T&&T.z<=b;){if(T.x>=p&&T.x<=v&&T.y>=g&&T.y<=m&&T!==r&&T!==a&&Pi(o,u,l,h,c,d,T.x,T.y)&&at(T.prev,T,T.next)>=0)return!1;T=T.nextZ}return!0}function Ux(i,e,t){let n=i;do{const r=n.prev,s=n.next.next;!ns(r,s)&&zc(r,n,n.next,s)&&rr(r,s)&&rr(s,r)&&(e.push(r.i/t|0),e.push(n.i/t|0),e.push(s.i/t|0),sr(n),sr(n.next),n=i=s),n=n.next}while(n!==i);return ri(n)}function Nx(i,e,t,n,r,s){let a=i;do{let o=a.next.next;for(;o!==a.prev;){if(a.i!==o.i&&Wx(a,o)){let l=kc(a,o);a=ri(a,a.next),l=ri(l,l.next),ir(a,e,t,n,r,s,0),ir(l,e,t,n,r,s,0);return}o=o.next}a=a.next}while(a!==i)}function Ox(i,e,t,n){const r=[];let s,a,o,l,c;for(s=0,a=e.length;s<a;s++)o=e[s]*n,l=s<a-1?e[s+1]*n:i.length,c=Bc(i,o,l,n,!1),c===c.next&&(c.steiner=!0),r.push(Vx(c));for(r.sort(Fx),s=0;s<r.length;s++)t=Bx(r[s],t);return t}function Fx(i,e){return i.x-e.x}function Bx(i,e){const t=zx(i,e);if(!t)return e;const n=kc(t,i);return ri(n,n.next),ri(t,t.next)}function zx(i,e){let t=e,n=-1/0,r;const s=i.x,a=i.y;do{if(a<=t.y&&a>=t.next.y&&t.next.y!==t.y){const d=t.x+(a-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(d<=s&&d>n&&(n=d,r=t.x<t.next.x?t:t.next,d===s))return r}t=t.next}while(t!==e);if(!r)return null;const o=r,l=r.x,c=r.y;let u=1/0,h;t=r;do s>=t.x&&t.x>=l&&s!==t.x&&Pi(a<c?s:n,a,l,c,a<c?n:s,a,t.x,t.y)&&(h=Math.abs(a-t.y)/(s-t.x),rr(t,i)&&(h<u||h===u&&(t.x>r.x||t.x===r.x&&kx(r,t)))&&(r=t,u=h)),t=t.next;while(t!==o);return r}function kx(i,e){return at(i.prev,i,e.prev)<0&&at(e.next,i,i.next)<0}function Hx(i,e,t,n){let r=i;do r.z===0&&(r.z=to(r.x,r.y,e,t,n)),r.prevZ=r.prev,r.nextZ=r.next,r=r.next;while(r!==i);r.prevZ.nextZ=null,r.prevZ=null,Gx(r)}function Gx(i){let e,t,n,r,s,a,o,l,c=1;do{for(t=i,i=null,s=null,a=0;t;){for(a++,n=t,o=0,e=0;e<c&&(o++,n=n.nextZ,!!n);e++);for(l=c;o>0||l>0&&n;)o!==0&&(l===0||!n||t.z<=n.z)?(r=t,t=t.nextZ,o--):(r=n,n=n.nextZ,l--),s?s.nextZ=r:i=r,r.prevZ=s,s=r;t=n}s.nextZ=null,c*=2}while(a>1);return i}function to(i,e,t,n,r){return i=(i-t)*r|0,e=(e-n)*r|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,i|e<<1}function Vx(i){let e=i,t=i;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==i);return t}function Pi(i,e,t,n,r,s,a,o){return(r-a)*(e-o)>=(i-a)*(s-o)&&(i-a)*(n-o)>=(t-a)*(e-o)&&(t-a)*(s-o)>=(r-a)*(n-o)}function Wx(i,e){return i.next.i!==e.i&&i.prev.i!==e.i&&!Xx(i,e)&&(rr(i,e)&&rr(e,i)&&qx(i,e)&&(at(i.prev,i,e.prev)||at(i,e.prev,e))||ns(i,e)&&at(i.prev,i,i.next)>0&&at(e.prev,e,e.next)>0)}function at(i,e,t){return(e.y-i.y)*(t.x-e.x)-(e.x-i.x)*(t.y-e.y)}function ns(i,e){return i.x===e.x&&i.y===e.y}function zc(i,e,t,n){const r=zr(at(i,e,t)),s=zr(at(i,e,n)),a=zr(at(t,n,i)),o=zr(at(t,n,e));return!!(r!==s&&a!==o||r===0&&Br(i,t,e)||s===0&&Br(i,n,e)||a===0&&Br(t,i,n)||o===0&&Br(t,e,n))}function Br(i,e,t){return e.x<=Math.max(i.x,t.x)&&e.x>=Math.min(i.x,t.x)&&e.y<=Math.max(i.y,t.y)&&e.y>=Math.min(i.y,t.y)}function zr(i){return i>0?1:i<0?-1:0}function Xx(i,e){let t=i;do{if(t.i!==i.i&&t.next.i!==i.i&&t.i!==e.i&&t.next.i!==e.i&&zc(t,t.next,i,e))return!0;t=t.next}while(t!==i);return!1}function rr(i,e){return at(i.prev,i,i.next)<0?at(i,e,i.next)>=0&&at(i,i.prev,e)>=0:at(i,e,i.prev)<0||at(i,i.next,e)<0}function qx(i,e){let t=i,n=!1;const r=(i.x+e.x)/2,s=(i.y+e.y)/2;do t.y>s!=t.next.y>s&&t.next.y!==t.y&&r<(t.next.x-t.x)*(s-t.y)/(t.next.y-t.y)+t.x&&(n=!n),t=t.next;while(t!==i);return n}function kc(i,e){const t=new no(i.i,i.x,i.y),n=new no(e.i,e.x,e.y),r=i.next,s=e.prev;return i.next=e,e.prev=i,t.next=r,r.prev=t,n.next=t,t.prev=n,s.next=n,n.prev=s,n}function xl(i,e,t,n){const r=new no(i,e,t);return n?(r.next=n.next,r.prev=n,n.next.prev=r,n.next=r):(r.prev=r,r.next=r),r}function sr(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function no(i,e,t){this.i=i,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function $x(i,e,t,n){let r=0;for(let s=e,a=t-n;s<t;s+=n)r+=(i[a]-i[s])*(i[s+1]+i[a+1]),a=s;return r}class Ui{static area(e){const t=e.length;let n=0;for(let r=t-1,s=0;s<t;r=s++)n+=e[r].x*e[s].y-e[s].x*e[r].y;return n*.5}static isClockWise(e){return Ui.area(e)<0}static triangulateShape(e,t){const n=[],r=[],s=[];Ml(e),Sl(n,e);let a=e.length;t.forEach(Ml);for(let l=0;l<t.length;l++)r.push(a),a+=t[l].length,Sl(n,t[l]);const o=Px.triangulate(n,r);for(let l=0;l<o.length;l+=3)s.push(o.slice(l,l+3));return s}}function Ml(i){const e=i.length;e>2&&i[e-1].equals(i[0])&&i.pop()}function Sl(i,e){for(let t=0;t<e.length;t++)i.push(e[t].x),i.push(e[t].y)}class Ao extends Bn{constructor(e=new Vr([new ce(.5,.5),new ce(-.5,.5),new ce(-.5,-.5),new ce(.5,-.5)]),t={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:e,options:t},e=Array.isArray(e)?e:[e];const n=this,r=[],s=[];for(let o=0,l=e.length;o<l;o++){const c=e[o];a(c)}this.setAttribute("position",new En(r,3)),this.setAttribute("uv",new En(s,2)),this.computeVertexNormals();function a(o){const l=[],c=t.curveSegments!==void 0?t.curveSegments:12,u=t.steps!==void 0?t.steps:1,h=t.depth!==void 0?t.depth:1;let d=t.bevelEnabled!==void 0?t.bevelEnabled:!0,p=t.bevelThickness!==void 0?t.bevelThickness:.2,g=t.bevelSize!==void 0?t.bevelSize:p-.1,v=t.bevelOffset!==void 0?t.bevelOffset:0,m=t.bevelSegments!==void 0?t.bevelSegments:3;const f=t.extrudePath,b=t.UVGenerator!==void 0?t.UVGenerator:Yx;let _,T=!1,A,P,L,y;f&&(_=f.getSpacedPoints(u),T=!0,d=!1,A=f.computeFrenetFrames(u,!1),P=new U,L=new U,y=new U),d||(m=0,p=0,g=0,v=0);const x=o.extractPoints(c);let E=x.shape;const z=x.holes;if(!Ui.isClockWise(E)){E=E.reverse();for(let C=0,ae=z.length;C<ae;C++){const K=z[C];Ui.isClockWise(K)&&(z[C]=K.reverse())}}const I=Ui.triangulateShape(E,z),N=E;for(let C=0,ae=z.length;C<ae;C++){const K=z[C];E=E.concat(K)}function F(C,ae,K){return ae||console.error("THREE.ExtrudeGeometry: vec does not exist"),C.clone().addScaledVector(ae,K)}const W=E.length,G=I.length;function q(C,ae,K){let se,J,Ae;const ge=C.x-ae.x,xe=C.y-ae.y,Ue=K.x-C.x,We=K.y-C.y,st=ge*ge+xe*xe,w=ge*We-xe*Ue;if(Math.abs(w)>Number.EPSILON){const M=Math.sqrt(st),X=Math.sqrt(Ue*Ue+We*We),oe=ae.x-xe/M,re=ae.y+ge/M,R=K.x-We/X,ee=K.y+Ue/X,ie=((R-oe)*We-(ee-re)*Ue)/(ge*We-xe*Ue);se=oe+ge*ie-C.x,J=re+xe*ie-C.y;const H=se*se+J*J;if(H<=2)return new ce(se,J);Ae=Math.sqrt(H/2)}else{let M=!1;ge>Number.EPSILON?Ue>Number.EPSILON&&(M=!0):ge<-Number.EPSILON?Ue<-Number.EPSILON&&(M=!0):Math.sign(xe)===Math.sign(We)&&(M=!0),M?(se=-xe,J=ge,Ae=Math.sqrt(st)):(se=ge,J=xe,Ae=Math.sqrt(st/2))}return new ce(se/Ae,J/Ae)}const Z=[];for(let C=0,ae=N.length,K=ae-1,se=C+1;C<ae;C++,K++,se++)K===ae&&(K=0),se===ae&&(se=0),Z[C]=q(N[C],N[K],N[se]);const Q=[];let de,k=Z.concat();for(let C=0,ae=z.length;C<ae;C++){const K=z[C];de=[];for(let se=0,J=K.length,Ae=J-1,ge=se+1;se<J;se++,Ae++,ge++)Ae===J&&(Ae=0),ge===J&&(ge=0),de[se]=q(K[se],K[Ae],K[ge]);Q.push(de),k=k.concat(de)}for(let C=0;C<m;C++){const ae=C/m,K=p*Math.cos(ae*Math.PI/2),se=g*Math.sin(ae*Math.PI/2)+v;for(let J=0,Ae=N.length;J<Ae;J++){const ge=F(N[J],Z[J],se);Me(ge.x,ge.y,-K)}for(let J=0,Ae=z.length;J<Ae;J++){const ge=z[J];de=Q[J];for(let xe=0,Ue=ge.length;xe<Ue;xe++){const We=F(ge[xe],de[xe],se);Me(We.x,We.y,-K)}}}const te=g+v;for(let C=0;C<W;C++){const ae=d?F(E[C],k[C],te):E[C];T?(L.copy(A.normals[0]).multiplyScalar(ae.x),P.copy(A.binormals[0]).multiplyScalar(ae.y),y.copy(_[0]).add(L).add(P),Me(y.x,y.y,y.z)):Me(ae.x,ae.y,0)}for(let C=1;C<=u;C++)for(let ae=0;ae<W;ae++){const K=d?F(E[ae],k[ae],te):E[ae];T?(L.copy(A.normals[C]).multiplyScalar(K.x),P.copy(A.binormals[C]).multiplyScalar(K.y),y.copy(_[C]).add(L).add(P),Me(y.x,y.y,y.z)):Me(K.x,K.y,h/u*C)}for(let C=m-1;C>=0;C--){const ae=C/m,K=p*Math.cos(ae*Math.PI/2),se=g*Math.sin(ae*Math.PI/2)+v;for(let J=0,Ae=N.length;J<Ae;J++){const ge=F(N[J],Z[J],se);Me(ge.x,ge.y,h+K)}for(let J=0,Ae=z.length;J<Ae;J++){const ge=z[J];de=Q[J];for(let xe=0,Ue=ge.length;xe<Ue;xe++){const We=F(ge[xe],de[xe],se);T?Me(We.x,We.y+_[u-1].y,_[u-1].x+K):Me(We.x,We.y,h+K)}}}ne(),fe();function ne(){const C=r.length/3;if(d){let ae=0,K=W*ae;for(let se=0;se<G;se++){const J=I[se];Ie(J[2]+K,J[1]+K,J[0]+K)}ae=u+m*2,K=W*ae;for(let se=0;se<G;se++){const J=I[se];Ie(J[0]+K,J[1]+K,J[2]+K)}}else{for(let ae=0;ae<G;ae++){const K=I[ae];Ie(K[2],K[1],K[0])}for(let ae=0;ae<G;ae++){const K=I[ae];Ie(K[0]+W*u,K[1]+W*u,K[2]+W*u)}}n.addGroup(C,r.length/3-C,0)}function fe(){const C=r.length/3;let ae=0;ve(N,ae),ae+=N.length;for(let K=0,se=z.length;K<se;K++){const J=z[K];ve(J,ae),ae+=J.length}n.addGroup(C,r.length/3-C,1)}function ve(C,ae){let K=C.length;for(;--K>=0;){const se=K;let J=K-1;J<0&&(J=C.length-1);for(let Ae=0,ge=u+m*2;Ae<ge;Ae++){const xe=W*Ae,Ue=W*(Ae+1),We=ae+se+xe,st=ae+J+xe,w=ae+J+Ue,M=ae+se+Ue;Le(We,st,w,M)}}}function Me(C,ae,K){l.push(C),l.push(ae),l.push(K)}function Ie(C,ae,K){Ye(C),Ye(ae),Ye(K);const se=r.length/3,J=b.generateTopUV(n,r,se-3,se-2,se-1);Pe(J[0]),Pe(J[1]),Pe(J[2])}function Le(C,ae,K,se){Ye(C),Ye(ae),Ye(se),Ye(ae),Ye(K),Ye(se);const J=r.length/3,Ae=b.generateSideWallUV(n,r,J-6,J-3,J-2,J-1);Pe(Ae[0]),Pe(Ae[1]),Pe(Ae[3]),Pe(Ae[1]),Pe(Ae[2]),Pe(Ae[3])}function Ye(C){r.push(l[C*3+0]),r.push(l[C*3+1]),r.push(l[C*3+2])}function Pe(C){s.push(C.x),s.push(C.y)}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes,n=this.parameters.options;return jx(t,n,e)}static fromJSON(e,t){const n=[];for(let s=0,a=e.shapes.length;s<a;s++){const o=t[e.shapes[s]];n.push(o)}const r=e.options.extrudePath;return r!==void 0&&(e.options.extrudePath=new Fc[r.type]().fromJSON(r)),new Ao(n,e.options)}}const Yx={generateTopUV:function(i,e,t,n,r){const s=e[t*3],a=e[t*3+1],o=e[n*3],l=e[n*3+1],c=e[r*3],u=e[r*3+1];return[new ce(s,a),new ce(o,l),new ce(c,u)]},generateSideWallUV:function(i,e,t,n,r,s){const a=e[t*3],o=e[t*3+1],l=e[t*3+2],c=e[n*3],u=e[n*3+1],h=e[n*3+2],d=e[r*3],p=e[r*3+1],g=e[r*3+2],v=e[s*3],m=e[s*3+1],f=e[s*3+2];return Math.abs(o-u)<Math.abs(a-c)?[new ce(a,1-l),new ce(c,1-h),new ce(d,1-g),new ce(v,1-f)]:[new ce(o,1-l),new ce(u,1-h),new ce(p,1-g),new ce(m,1-f)]}};function jx(i,e,t){if(t.shapes=[],Array.isArray(i))for(let n=0,r=i.length;n<r;n++){const s=i[n];t.shapes.push(s.uuid)}else t.shapes.push(i.uuid);return t.options=Object.assign({},e),e.extrudePath!==void 0&&(t.options.extrudePath=e.extrudePath.toJSON()),t}class Kx extends cr{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new et(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new et(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=fc,this.normalScale=new ce(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Zx extends Kx{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new ce(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return St(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new et(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new et(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new et(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}const Kr={enabled:!1,files:{},add:function(i,e){this.enabled!==!1&&(this.files[i]=e)},get:function(i){if(this.enabled!==!1)return this.files[i]},remove:function(i){delete this.files[i]},clear:function(){this.files={}}};class Jx{constructor(e,t,n){const r=this;let s=!1,a=0,o=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=n,this.itemStart=function(u){o++,s===!1&&r.onStart!==void 0&&r.onStart(u,a,o),s=!0},this.itemEnd=function(u){a++,r.onProgress!==void 0&&r.onProgress(u,a,o),a===o&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return l?l(u):u},this.setURLModifier=function(u){return l=u,this},this.addHandler=function(u,h){return c.push(u,h),this},this.removeHandler=function(u){const h=c.indexOf(u);return h!==-1&&c.splice(h,2),this},this.getHandler=function(u){for(let h=0,d=c.length;h<d;h+=2){const p=c[h],g=c[h+1];if(p.global&&(p.lastIndex=0),p.test(u))return g}return null}}}const Qx=new Jx;class is{constructor(e){this.manager=e!==void 0?e:Qx,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const n=this;return new Promise(function(r,s){n.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}const mn={};class eM extends Error{constructor(e,t){super(e),this.response=t}}class tM extends is{constructor(e){super(e)}load(e,t,n,r){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=Kr.get(e);if(s!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(s),this.manager.itemEnd(e)},0),s;if(mn[e]!==void 0){mn[e].push({onLoad:t,onProgress:n,onError:r});return}mn[e]=[],mn[e].push({onLoad:t,onProgress:n,onError:r});const a=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),o=this.mimeType,l=this.responseType;fetch(a).then(c=>{if(c.status===200||c.status===0){if(c.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||c.body===void 0||c.body.getReader===void 0)return c;const u=mn[e],h=c.body.getReader(),d=c.headers.get("Content-Length")||c.headers.get("X-File-Size"),p=d?parseInt(d):0,g=p!==0;let v=0;const m=new ReadableStream({start(f){b();function b(){h.read().then(({done:_,value:T})=>{if(_)f.close();else{v+=T.byteLength;const A=new ProgressEvent("progress",{lengthComputable:g,loaded:v,total:p});for(let P=0,L=u.length;P<L;P++){const y=u[P];y.onProgress&&y.onProgress(A)}f.enqueue(T),b()}})}}});return new Response(m)}else throw new eM(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)}).then(c=>{switch(l){case"arraybuffer":return c.arrayBuffer();case"blob":return c.blob();case"document":return c.text().then(u=>new DOMParser().parseFromString(u,o));case"json":return c.json();default:if(o===void 0)return c.text();{const h=/charset="?([^;"\s]*)"?/i.exec(o),d=h&&h[1]?h[1].toLowerCase():void 0,p=new TextDecoder(d);return c.arrayBuffer().then(g=>p.decode(g))}}}).then(c=>{Kr.add(e,c);const u=mn[e];delete mn[e];for(let h=0,d=u.length;h<d;h++){const p=u[h];p.onLoad&&p.onLoad(c)}}).catch(c=>{const u=mn[e];if(u===void 0)throw this.manager.itemError(e),c;delete mn[e];for(let h=0,d=u.length;h<d;h++){const p=u[h];p.onError&&p.onError(c)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class nM extends is{constructor(e){super(e)}load(e,t,n,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,a=Kr.get(e);if(a!==void 0)return s.manager.itemStart(e),setTimeout(function(){t&&t(a),s.manager.itemEnd(e)},0),a;const o=nr("img");function l(){u(),Kr.add(e,this),t&&t(this),s.manager.itemEnd(e)}function c(h){u(),r&&r(h),s.manager.itemError(e),s.manager.itemEnd(e)}function u(){o.removeEventListener("load",l,!1),o.removeEventListener("error",c,!1)}return o.addEventListener("load",l,!1),o.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(o.crossOrigin=this.crossOrigin),s.manager.itemStart(e),o.src=e,o}}class iM extends is{constructor(e){super(e)}load(e,t,n,r){const s=new Ut,a=new nM(this.manager);return a.setCrossOrigin(this.crossOrigin),a.setPath(this.path),a.load(e,function(o){s.image=o,s.needsUpdate=!0,t!==void 0&&t(s)},n,r),s}}class yl{constructor(e=1,t=0,n=0){return this.radius=e,this.phi=t,this.theta=n,this}set(e,t,n){return this.radius=e,this.phi=t,this.theta=n,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,n){return this.radius=Math.sqrt(e*e+t*t+n*n),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,n),this.phi=Math.acos(St(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}class rM{constructor(){this.type="ShapePath",this.color=new et,this.subPaths=[],this.currentPath=null}moveTo(e,t){return this.currentPath=new eo,this.subPaths.push(this.currentPath),this.currentPath.moveTo(e,t),this}lineTo(e,t){return this.currentPath.lineTo(e,t),this}quadraticCurveTo(e,t,n,r){return this.currentPath.quadraticCurveTo(e,t,n,r),this}bezierCurveTo(e,t,n,r,s,a){return this.currentPath.bezierCurveTo(e,t,n,r,s,a),this}splineThru(e){return this.currentPath.splineThru(e),this}toShapes(e){function t(f){const b=[];for(let _=0,T=f.length;_<T;_++){const A=f[_],P=new Vr;P.curves=A.curves,b.push(P)}return b}function n(f,b){const _=b.length;let T=!1;for(let A=_-1,P=0;P<_;A=P++){let L=b[A],y=b[P],x=y.x-L.x,E=y.y-L.y;if(Math.abs(E)>Number.EPSILON){if(E<0&&(L=b[P],x=-x,y=b[A],E=-E),f.y<L.y||f.y>y.y)continue;if(f.y===L.y){if(f.x===L.x)return!0}else{const z=E*(f.x-L.x)-x*(f.y-L.y);if(z===0)return!0;if(z<0)continue;T=!T}}else{if(f.y!==L.y)continue;if(y.x<=f.x&&f.x<=L.x||L.x<=f.x&&f.x<=y.x)return!0}}return T}const r=Ui.isClockWise,s=this.subPaths;if(s.length===0)return[];let a,o,l;const c=[];if(s.length===1)return o=s[0],l=new Vr,l.curves=o.curves,c.push(l),c;let u=!r(s[0].getPoints());u=e?!u:u;const h=[],d=[];let p=[],g=0,v;d[g]=void 0,p[g]=[];for(let f=0,b=s.length;f<b;f++)o=s[f],v=o.getPoints(),a=r(v),a=e?!a:a,a?(!u&&d[g]&&g++,d[g]={s:new Vr,p:v},d[g].s.curves=o.curves,u&&g++,p[g]=[]):p[g].push({h:o,p:v[0]});if(!d[0])return t(s);if(d.length>1){let f=!1,b=0;for(let _=0,T=d.length;_<T;_++)h[_]=[];for(let _=0,T=d.length;_<T;_++){const A=p[_];for(let P=0;P<A.length;P++){const L=A[P];let y=!0;for(let x=0;x<d.length;x++)n(L.p,d[x].p)&&(_!==x&&b++,y?(y=!1,h[x].push(L)):f=!0);y&&h[_].push(L)}}b>0&&f===!1&&(p=h)}let m;for(let f=0,b=d.length;f<b;f++){l=d[f].s,c.push(l),m=p[f];for(let _=0,T=m.length;_<T;_++)l.holes.push(m[_].h)}return c}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:vo}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=vo);const El={type:"change"},Vs={type:"start"},bl={type:"end"};class sM extends li{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:ui.ROTATE,MIDDLE:ui.DOLLY,RIGHT:ui.PAN},this.touches={ONE:hi.ROTATE,TWO:hi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(R){R.addEventListener("keydown",Ue),this._domElementKeyEvents=R},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Ue),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(El),n.update(),s=r.NONE},this.update=function(){const R=new U,ee=new ni().setFromUnitVectors(e.up,new U(0,1,0)),ie=ee.clone().invert(),H=new U,Ee=new ni,Re=new U,we=2*Math.PI;return function(){const Se=n.object.position;R.copy(Se).sub(n.target),R.applyQuaternion(ee),o.setFromVector3(R),n.autoRotate&&s===r.NONE&&x(L()),n.enableDamping?(o.theta+=l.theta*n.dampingFactor,o.phi+=l.phi*n.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let Ne=n.minAzimuthAngle,qe=n.maxAzimuthAngle;return isFinite(Ne)&&isFinite(qe)&&(Ne<-Math.PI?Ne+=we:Ne>Math.PI&&(Ne-=we),qe<-Math.PI?qe+=we:qe>Math.PI&&(qe-=we),Ne<=qe?o.theta=Math.max(Ne,Math.min(qe,o.theta)):o.theta=o.theta>(Ne+qe)/2?Math.max(Ne,o.theta):Math.min(qe,o.theta)),o.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,o.phi)),o.makeSafe(),o.radius*=c,o.radius=Math.max(n.minDistance,Math.min(n.maxDistance,o.radius)),n.enableDamping===!0?n.target.addScaledVector(u,n.dampingFactor):n.target.add(u),R.setFromSpherical(o),R.applyQuaternion(ie),Se.copy(n.target).add(R),n.object.lookAt(n.target),n.enableDamping===!0?(l.theta*=1-n.dampingFactor,l.phi*=1-n.dampingFactor,u.multiplyScalar(1-n.dampingFactor)):(l.set(0,0,0),u.set(0,0,0)),c=1,h||H.distanceToSquared(n.object.position)>a||8*(1-Ee.dot(n.object.quaternion))>a||Re.distanceToSquared(n.target)>0?(n.dispatchEvent(El),H.copy(n.object.position),Ee.copy(n.object.quaternion),Re.copy(n.target),h=!1,!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",w),n.domElement.removeEventListener("pointerdown",K),n.domElement.removeEventListener("pointercancel",J),n.domElement.removeEventListener("wheel",xe),n.domElement.removeEventListener("pointermove",se),n.domElement.removeEventListener("pointerup",J),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",Ue),n._domElementKeyEvents=null)};const n=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const a=1e-6,o=new yl,l=new yl;let c=1;const u=new U;let h=!1;const d=new ce,p=new ce,g=new ce,v=new ce,m=new ce,f=new ce,b=new ce,_=new ce,T=new ce,A=[],P={};function L(){return 2*Math.PI/60/60*n.autoRotateSpeed}function y(){return Math.pow(.95,n.zoomSpeed)}function x(R){l.theta-=R}function E(R){l.phi-=R}const z=function(){const R=new U;return function(ie,H){R.setFromMatrixColumn(H,0),R.multiplyScalar(-ie),u.add(R)}}(),$=function(){const R=new U;return function(ie,H){n.screenSpacePanning===!0?R.setFromMatrixColumn(H,1):(R.setFromMatrixColumn(H,0),R.crossVectors(n.object.up,R)),R.multiplyScalar(ie),u.add(R)}}(),I=function(){const R=new U;return function(ie,H){const Ee=n.domElement;if(n.object.isPerspectiveCamera){const Re=n.object.position;R.copy(Re).sub(n.target);let we=R.length();we*=Math.tan(n.object.fov/2*Math.PI/180),z(2*ie*we/Ee.clientHeight,n.object.matrix),$(2*H*we/Ee.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(z(ie*(n.object.right-n.object.left)/n.object.zoom/Ee.clientWidth,n.object.matrix),$(H*(n.object.top-n.object.bottom)/n.object.zoom/Ee.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function N(R){n.object.isPerspectiveCamera?c/=R:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom*R)),n.object.updateProjectionMatrix(),h=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function F(R){n.object.isPerspectiveCamera?c*=R:n.object.isOrthographicCamera?(n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/R)),n.object.updateProjectionMatrix(),h=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function W(R){d.set(R.clientX,R.clientY)}function G(R){b.set(R.clientX,R.clientY)}function q(R){v.set(R.clientX,R.clientY)}function Z(R){p.set(R.clientX,R.clientY),g.subVectors(p,d).multiplyScalar(n.rotateSpeed);const ee=n.domElement;x(2*Math.PI*g.x/ee.clientHeight),E(2*Math.PI*g.y/ee.clientHeight),d.copy(p),n.update()}function Q(R){_.set(R.clientX,R.clientY),T.subVectors(_,b),T.y>0?N(y()):T.y<0&&F(y()),b.copy(_),n.update()}function de(R){m.set(R.clientX,R.clientY),f.subVectors(m,v).multiplyScalar(n.panSpeed),I(f.x,f.y),v.copy(m),n.update()}function k(R){R.deltaY<0?F(y()):R.deltaY>0&&N(y()),n.update()}function te(R){let ee=!1;switch(R.code){case n.keys.UP:R.ctrlKey||R.metaKey||R.shiftKey?E(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):I(0,n.keyPanSpeed),ee=!0;break;case n.keys.BOTTOM:R.ctrlKey||R.metaKey||R.shiftKey?E(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):I(0,-n.keyPanSpeed),ee=!0;break;case n.keys.LEFT:R.ctrlKey||R.metaKey||R.shiftKey?x(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):I(n.keyPanSpeed,0),ee=!0;break;case n.keys.RIGHT:R.ctrlKey||R.metaKey||R.shiftKey?x(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):I(-n.keyPanSpeed,0),ee=!0;break}ee&&(R.preventDefault(),n.update())}function ne(){if(A.length===1)d.set(A[0].pageX,A[0].pageY);else{const R=.5*(A[0].pageX+A[1].pageX),ee=.5*(A[0].pageY+A[1].pageY);d.set(R,ee)}}function fe(){if(A.length===1)v.set(A[0].pageX,A[0].pageY);else{const R=.5*(A[0].pageX+A[1].pageX),ee=.5*(A[0].pageY+A[1].pageY);v.set(R,ee)}}function ve(){const R=A[0].pageX-A[1].pageX,ee=A[0].pageY-A[1].pageY,ie=Math.sqrt(R*R+ee*ee);b.set(0,ie)}function Me(){n.enableZoom&&ve(),n.enablePan&&fe()}function Ie(){n.enableZoom&&ve(),n.enableRotate&&ne()}function Le(R){if(A.length==1)p.set(R.pageX,R.pageY);else{const ie=re(R),H=.5*(R.pageX+ie.x),Ee=.5*(R.pageY+ie.y);p.set(H,Ee)}g.subVectors(p,d).multiplyScalar(n.rotateSpeed);const ee=n.domElement;x(2*Math.PI*g.x/ee.clientHeight),E(2*Math.PI*g.y/ee.clientHeight),d.copy(p)}function Ye(R){if(A.length===1)m.set(R.pageX,R.pageY);else{const ee=re(R),ie=.5*(R.pageX+ee.x),H=.5*(R.pageY+ee.y);m.set(ie,H)}f.subVectors(m,v).multiplyScalar(n.panSpeed),I(f.x,f.y),v.copy(m)}function Pe(R){const ee=re(R),ie=R.pageX-ee.x,H=R.pageY-ee.y,Ee=Math.sqrt(ie*ie+H*H);_.set(0,Ee),T.set(0,Math.pow(_.y/b.y,n.zoomSpeed)),N(T.y),b.copy(_)}function C(R){n.enableZoom&&Pe(R),n.enablePan&&Ye(R)}function ae(R){n.enableZoom&&Pe(R),n.enableRotate&&Le(R)}function K(R){n.enabled!==!1&&(A.length===0&&(n.domElement.setPointerCapture(R.pointerId),n.domElement.addEventListener("pointermove",se),n.domElement.addEventListener("pointerup",J)),M(R),R.pointerType==="touch"?We(R):Ae(R))}function se(R){n.enabled!==!1&&(R.pointerType==="touch"?st(R):ge(R))}function J(R){X(R),A.length===0&&(n.domElement.releasePointerCapture(R.pointerId),n.domElement.removeEventListener("pointermove",se),n.domElement.removeEventListener("pointerup",J)),n.dispatchEvent(bl),s=r.NONE}function Ae(R){let ee;switch(R.button){case 0:ee=n.mouseButtons.LEFT;break;case 1:ee=n.mouseButtons.MIDDLE;break;case 2:ee=n.mouseButtons.RIGHT;break;default:ee=-1}switch(ee){case ui.DOLLY:if(n.enableZoom===!1)return;G(R),s=r.DOLLY;break;case ui.ROTATE:if(R.ctrlKey||R.metaKey||R.shiftKey){if(n.enablePan===!1)return;q(R),s=r.PAN}else{if(n.enableRotate===!1)return;W(R),s=r.ROTATE}break;case ui.PAN:if(R.ctrlKey||R.metaKey||R.shiftKey){if(n.enableRotate===!1)return;W(R),s=r.ROTATE}else{if(n.enablePan===!1)return;q(R),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Vs)}function ge(R){switch(s){case r.ROTATE:if(n.enableRotate===!1)return;Z(R);break;case r.DOLLY:if(n.enableZoom===!1)return;Q(R);break;case r.PAN:if(n.enablePan===!1)return;de(R);break}}function xe(R){n.enabled===!1||n.enableZoom===!1||s!==r.NONE||(R.preventDefault(),n.dispatchEvent(Vs),k(R),n.dispatchEvent(bl))}function Ue(R){n.enabled===!1||n.enablePan===!1||te(R)}function We(R){switch(oe(R),A.length){case 1:switch(n.touches.ONE){case hi.ROTATE:if(n.enableRotate===!1)return;ne(),s=r.TOUCH_ROTATE;break;case hi.PAN:if(n.enablePan===!1)return;fe(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(n.touches.TWO){case hi.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Me(),s=r.TOUCH_DOLLY_PAN;break;case hi.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;Ie(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&n.dispatchEvent(Vs)}function st(R){switch(oe(R),s){case r.TOUCH_ROTATE:if(n.enableRotate===!1)return;Le(R),n.update();break;case r.TOUCH_PAN:if(n.enablePan===!1)return;Ye(R),n.update();break;case r.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;C(R),n.update();break;case r.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;ae(R),n.update();break;default:s=r.NONE}}function w(R){n.enabled!==!1&&R.preventDefault()}function M(R){A.push(R)}function X(R){delete P[R.pointerId];for(let ee=0;ee<A.length;ee++)if(A[ee].pointerId==R.pointerId){A.splice(ee,1);return}}function oe(R){let ee=P[R.pointerId];ee===void 0&&(ee=new ce,P[R.pointerId]=ee),ee.set(R.pageX,R.pageY)}function re(R){const ee=R.pointerId===A[0].pointerId?A[1]:A[0];return P[ee.pointerId]}n.domElement.addEventListener("contextmenu",w),n.domElement.addEventListener("pointerdown",K),n.domElement.addEventListener("pointercancel",J),n.domElement.addEventListener("wheel",xe,{passive:!1}),this.update()}}class oM extends is{constructor(e){super(e)}load(e,t,n,r){const s=this,a=new tM(this.manager);a.setPath(this.path),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(e,function(o){const l=s.parse(JSON.parse(o));t&&t(l)},n,r)}parse(e){return new aM(e)}}class aM{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const n=[],r=lM(e,t,this.data);for(let s=0,a=r.length;s<a;s++)n.push(...r[s].toShapes());return n}}function lM(i,e,t){const n=Array.from(i),r=e/t.resolution,s=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*r,a=[];let o=0,l=0;for(let c=0;c<n.length;c++){const u=n[c];if(u===`
`)o=0,l-=s;else{const h=cM(u,r,o,l,t);o+=h.offsetX,a.push(h.path)}}return a}function cM(i,e,t,n,r){const s=r.glyphs[i]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+i+'" does not exists in font family '+r.familyName+".");return}const a=new rM;let o,l,c,u,h,d,p,g;if(s.o){const v=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,f=v.length;m<f;)switch(v[m++]){case"m":o=v[m++]*e+t,l=v[m++]*e+n,a.moveTo(o,l);break;case"l":o=v[m++]*e+t,l=v[m++]*e+n,a.lineTo(o,l);break;case"q":c=v[m++]*e+t,u=v[m++]*e+n,h=v[m++]*e+t,d=v[m++]*e+n,a.quadraticCurveTo(h,d,c,u);break;case"b":c=v[m++]*e+t,u=v[m++]*e+n,h=v[m++]*e+t,d=v[m++]*e+n,p=v[m++]*e+t,g=v[m++]*e+n,a.bezierCurveTo(h,d,p,g,c,u);break}}return{offsetX:s.ha*e,path:a}}class uM extends Ao{constructor(e,t={}){const n=t.font;if(n===void 0)super();else{const r=n.generateShapes(e,t.size);t.depth=t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const hM=Ke({__name:"HomeTitle",props:{title:{default:"标题"}},setup(i){const e=i,t=tt(),n=new _x,r=new Vt(45,void 0,1,2e3);r.position.set(0,0,400);const s=new iM().load(Ji("/textures/environment.png"));s.mapping=Yr,n.environment=s,new oM().load(Ji("/fonts/STXingKai.json"),h=>{const d=new uM(e.title,{font:h,size:80,height:5,curveSegments:12,bevelEnabled:!0,bevelThickness:4,bevelSize:2,bevelOffset:0,bevelSegments:5});d.center();const p=new Zx({color:38911,roughness:0,reflectivity:1,thickness:80,ior:1.5,transmission:1,side:rn,emissive:38911,emissiveIntensity:.1}),g=new xn(d,p);n.add(g)});const o=new Ic({antialias:!0,alpha:!0}),l=new sM(r,o.domElement);l.enableDamping=!0,l.autoRotate=!0,l.autoRotateSpeed=3,function h(){requestAnimationFrame(h),l.update(),o.render(n,r)}();function c(){document.querySelector("#main-title").insertAdjacentElement("afterend",t.value)}function u(){var p,g;const h=(p=t.value)==null?void 0:p.clientWidth,d=(g=t.value)==null?void 0:g.clientHeight;r.aspect=h/d,r.updateProjectionMatrix(),o.setSize(h,d),o.setPixelRatio(window.devicePixelRatio)}return kt(()=>{u(),t.value.appendChild(o.domElement),c(),window.addEventListener("resize",u)}),ao(()=>{window.removeEventListener("resize",u)}),(h,d)=>(me(),Ce("div",{class:"home-title",ref_key:"homeTitleRef",ref:t},null,512))}});const dM=rt(hM,[["__scopeId","data-v-26051056"],["__file","HomeTitle.vue"]]),fM=An({enhance({app:i,router:e,siteData:t}){i.component("PluginIconCom",fp),i.component("HomeTitle",dM),e.beforeEach(n=>{}),e.afterEach(n=>{})},setup(){},rootComponents:[]}),kr=[Lu,Iu,Fu,ju,Qu,sh,jf,up,fM],pM=[["v-8daa1a0e","/",{title:""},["/index.html","/README.md"]],["v-1d8755e3","/choosing-technology/",{title:"技术选型"},["/choosing-technology/index.html","/choosing-technology/README.md"]],["v-25f247c9","/develop-standard/",{title:"样式规范"},["/develop-standard/index.html","/develop-standard/README.md"]],["v-16d350a3","/develop-standard/javascript.html",{title:"JavaScript 规范"},["/develop-standard/javascript","/develop-standard/javascript.md"]],["v-16505f43","/develop-standard/react.html",{title:"React 规范"},["/develop-standard/react","/develop-standard/react.md"]],["v-4de4cc8b","/develop-standard/typescript.html",{title:"TypeScript 规范"},["/develop-standard/typescript","/develop-standard/typescript.md"]],["v-6a2021de","/develop-standard/uni-app.html",{title:"uni-app 规范"},["/develop-standard/uni-app","/develop-standard/uni-app.md"]],["v-368ce9dc","/develop-standard/vue.html",{title:"Vue 规范"},["/develop-standard/vue","/develop-standard/vue.md"]],["v-8a459346","/develop-tools/",{title:"NVM"},["/develop-tools/index.html","/develop-tools/README.md"]],["v-49e0da1e","/develop-tools/hbuilderx.html",{title:"HBuilderX"},["/develop-tools/hbuilderx","/develop-tools/hbuilderx.md"]],["v-69705532","/develop-tools/node-and-npm.html",{title:"Node 和 NPM"},["/develop-tools/node-and-npm","/develop-tools/node-and-npm.md"]],["v-f94cb34c","/develop-tools/node.html",{title:"Node"},["/develop-tools/node","/develop-tools/node.md"]],["v-c84bb1d0","/develop-tools/other-tools.html",{title:"其他工具"},["/develop-tools/other-tools","/develop-tools/other-tools.md"]],["v-b64f52aa","/develop-tools/svn.html",{title:"SVN"},["/develop-tools/svn","/develop-tools/svn.md"]],["v-5794b970","/develop-tools/todesk.html",{title:"ToDesk"},["/develop-tools/todesk","/develop-tools/todesk.md"]],["v-25f19272","/develop-tools/vscode.html",{title:"VSCode"},["/develop-tools/vscode","/develop-tools/vscode.md"]],["v-ebd5c936","/develop-tools/weixin-devtools.html",{title:"微信开发者工具"},["/develop-tools/weixin-devtools","/develop-tools/weixin-devtools.md"]],["v-7b28dbcc","/tips-share/",{title:"编程 Tips"},["/tips-share/index.html","/tips-share/README.md"]],["v-3706649a","/404.html",{title:""},["/404"]]];var Tl=Ke({name:"Vuepress",setup(){const i=xu();return()=>Je(i.value)}}),mM=()=>pM.reduce((i,[e,t,n,r])=>(i.push({name:e,path:t,component:Tl,meta:n},...r.map(s=>({path:s,redirect:t}))),i),[{name:"404",path:"/:catchAll(.*)",component:Tl}]),gM=lu,_M=()=>{const i=su({history:gM(Ll("/frontend-development-guide/")),routes:mM(),scrollBehavior:(e,t,n)=>n||(e.hash?{el:e.hash}:{top:0})});return i.beforeResolve(async(e,t)=>{var n;(e.path!==t.path||t===ou)&&([Pn.value]=await Promise.all([gn.resolvePageData(e.name),(n=Pl[e.name])==null?void 0:n.__asyncLoader()]))}),i},vM=i=>{i.component("ClientOnly",ho),i.component("Content",bu)},xM=(i,e,t)=>{const n=tt(e.currentRoute.value.path);oi(()=>e.currentRoute.value.path,d=>n.value=d);const r=Te(()=>gn.resolveLayouts(t)),s=Te(()=>gn.resolveRouteLocale(Ci.value.locales,n.value)),a=Te(()=>gn.resolveSiteLocaleData(Ci.value,s.value)),o=Te(()=>gn.resolvePageFrontmatter(Pn.value)),l=Te(()=>gn.resolvePageHeadTitle(Pn.value,a.value)),c=Te(()=>gn.resolvePageHead(l.value,o.value,a.value)),u=Te(()=>gn.resolvePageLang(Pn.value)),h=Te(()=>gn.resolvePageLayout(Pn.value,r.value));return i.provide(pu,r),i.provide(Il,o),i.provide(_u,l),i.provide(Ul,c),i.provide(Nl,u),i.provide(Ol,h),i.provide(co,s),i.provide(Fl,a),Object.defineProperties(i.config.globalProperties,{$frontmatter:{get:()=>o.value},$head:{get:()=>c.value},$headTitle:{get:()=>l.value},$lang:{get:()=>u.value},$page:{get:()=>Pn.value},$routeLocale:{get:()=>s.value},$site:{get:()=>Ci.value},$siteLocale:{get:()=>a.value},$withBase:{get:()=>Ji}}),{layouts:r,pageData:Pn,pageFrontmatter:o,pageHead:c,pageHeadTitle:l,pageLang:u,pageLayout:h,routeLocale:s,siteData:Ci,siteLocaleData:a}},MM=()=>{const i=gu(),e=vu(),t=tt([]),n=()=>{i.value.forEach(s=>{const a=SM(s);a&&t.value.push(a)})},r=()=>{document.documentElement.lang=e.value,t.value.forEach(s=>{s.parentNode===document.head&&document.head.removeChild(s)}),t.value.splice(0,t.value.length),i.value.forEach(s=>{const a=yM(s);a!==null&&(document.head.appendChild(a),t.value.push(a))})};oo(Su,r),kt(()=>{n(),r(),oi(()=>i.value,()=>r())})},SM=([i,e,t=""])=>{const n=Object.entries(e).map(([o,l])=>Qt(l)?`[${o}=${JSON.stringify(l)}]`:l===!0?`[${o}]`:"").join(""),r=`head > ${i}${n}`;return Array.from(document.querySelectorAll(r)).find(o=>o.innerText===t)||null},yM=([i,e,t])=>{if(!Qt(i))return null;const n=document.createElement(i);return lo(e)&&Object.entries(e).forEach(([r,s])=>{Qt(s)?n.setAttribute(r,s):s===!0&&n.setAttribute(r,"")}),Qt(t)&&n.appendChild(document.createTextNode(t)),n},EM=au,bM=async()=>{var t;const i=EM({name:"VuepressApp",setup(){var n;MM();for(const r of kr)(n=r.setup)==null||n.call(r);return()=>[Je(cu),...kr.flatMap(({rootComponents:r=[]})=>r.map(s=>Je(s)))]}}),e=_M();vM(i),xM(i,e,kr);for(const n of kr)await((t=n.enhance)==null?void 0:t.call(n,{app:i,router:e,siteData:Ci}));return i.use(e),{app:i,router:e}};bM().then(({app:i,router:e})=>{e.isReady().then(()=>{i.mount("#app")})});export{bM as createVueApp};
