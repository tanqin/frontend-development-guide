import{_ as l,M as o,p as u,q as r,N as a,V as t,a1 as e,R as n,t as s}from"./framework-5866ffd3.js";const i={},k=e(`<h1 id="样式规范" tabindex="-1"><a class="header-anchor" href="#样式规范" aria-hidden="true">#</a> 样式规范</h1><h2 id="类选择器" tabindex="-1"><a class="header-anchor" href="#类选择器" aria-hidden="true">#</a> 类选择器</h2><ul><li>类选择器由多个词组成时，类名统一使用中横线（-）作为分隔符。</li></ul><div class="custom-container tip"><p class="custom-container-title">原因：</p><p>根据 HTML 和 XML 规范，中横线（-）被定义为有效的标识符字符。而下划线（_）则不是一个有效的标识符字符。</p></div><div class="language-css" data-ext="css"><pre class="language-css"><code><span class="token comment">/* ❌ bad */</span>
...
</code></pre></div><hr></details>`,7);function h(b,m){const p=o("CodeGroupItem"),c=o("CodeGroup");return u(),r("div",null,[k,a(c,null,{default:t(()=>[a(p,{title:"css",active:""},{default:t(()=>[d]),_:1}),a(p,{title:"less"},{default:t(()=>[y]),_:1}),a(p,{title:"scss"},{default:t(()=>[g]),_:1})]),_:1}),x])}const _=l(i,[["render",h],["__file","index.html.vue"]]);export{_ as default};
